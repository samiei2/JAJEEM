...
public class ConnectionDialog extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		jComboBoxConfig = new javax.swing.JComboBox(
				FileUtility.getSideConfigFiles(Commons.viewerSide));
		...
		jPanel1.setBorder(javax.swing.BorderFactory
				.createTitledBorder("Authentication"));
		...
		jPanel3.setBorder(javax.swing.BorderFactory
				.createTitledBorder("Connection mode"));
		...
		jButtonOK.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/jrdesktop/images/ok.png"))); // NOI18N
		...
		java.awt.Dimension screenSize = java.awt.Toolkit.getDefaultToolkit()
				.getScreenSize();
		setBounds((screenSize.width - 369) / 2, (screenSize.height - 374) / 2,
				369, 374);
	...
	private void jButtonOKActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonOKActionPerformed
		...
		main.viewerConfig = new Config(Commons.viewerSide, config_name,
				jTextFieldIPAdr.getText(), Integer.parseInt(jTextFieldPort
						.getText()), jTextFieldUsername.getText(),
