...
public class FileTransGUI extends javax.swing.JFrame {
				...
				.setHorizontalGroup(jPanel1Layout
						...
						.add(jPanel1Layout
								...
								.add(jPanel1Layout
										.createParallelGroup(
												org.jdesktop.layout.GroupLayout.LEADING)
										.add(jLabelDuration).add(jLabel1))
								.add(jPanel1Layout
										.createParallelGroup(
												org.jdesktop.layout.GroupLayout.LEADING,
												false)
		...
		layout.setVerticalGroup(layout.createParallelGroup(
				...
				layout.createSequentialGroup()
						...
						.add(jPanel1,
								...
								org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(
								org.jdesktop.layout.LayoutStyle.RELATED, 7,
								Short.MAX_VALUE).add(jButtonClose)
						.addContainerGap()));

		java.awt.Dimension screenSize = java.awt.Toolkit.getDefaultToolkit()
				.getScreenSize();
		setBounds((screenSize.width - 608) / 2, (screenSize.height - 162) / 2,
				608, 162);
	...
	public void Done() {
		...
		jButtonClose.setIcon(new ImageIcon(getClass().getResource(
				"/jrdesktop/images/exit.png")));
		setTitle("File Transmission [Done !! ]");
	}

	public void ReceiveFiles(ArrayList arrayList) {
		setTitle("File Transmission [Receiving ...]");
		recorder.fileManager.setDownloadingFolder(arrayList.get(0).toString());
	...
	public void SendFiles(File[] files) {
		...
		recorder.fileManager.setUploadingFolder(files[0].getParent());
