...
public class Settings {
	...
	public static void loadConfig() {
		if (new File(configFile).canRead()) {
			try {
				...
				guiDisabled = Boolean.valueOf(properties
						.getProperty("GUI-Disabled"));
				exitDisabled = Boolean.valueOf(properties
						.getProperty("exit-Disabled"));
				systrayDisabled = Boolean.valueOf(properties
						.getProperty("Systray-Disabled"));
				proxyManual = Boolean.valueOf(properties
						.getProperty("Proxy-Manual"));
				proxyServer = properties.getProperty("Proxy-Server");
				proxyPort = Integer.valueOf(properties
	...
	public static void setConfig(boolean nogui, boolean nosystray,
			boolean noexit, boolean proxy_Manual, String proxy_Server,
			int proxy_Port, String _downloadsDir, String _lookAndFeel) {
