...
public class ServerImpl extends UnicastRemoteObject implements ServerInterface {
	...
	@Override
	public int startViewer(InetAddress inetAddress, String username,
			String password, boolean isReversedConnection)
			throws RemoteException {

		if (!RMIServer.serverConfig.username.equals(username)
				|| !RMIServer.serverConfig.password.equals(PasswordUtility
	...
	@Override
	public void setMouseEvents(int index, ArrayList events)
			throws RemoteException {
	...
	@Override
	public void setClipboardContent(Object object, int index)
			throws RemoteException {
	...
	@Override
	public void setOption(Object data, int index, int option)
			throws RemoteException {
	...
	@Override
	public void setHostProperties(int index, Hashtable props)
			throws RemoteException {
		if (RMIServer.serverConfig.reverseConnection) {
