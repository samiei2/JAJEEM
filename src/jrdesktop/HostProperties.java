...
public class HostProperties {
	...
	public static Hashtable getLocalProperties() {
		...
		localProperties.put("host-address", InetAdrUtility.getLocalHost()
				.toString());
	...
	public static void display(Hashtable prop) {
		...
		JOptionPane.showMessageDialog(null,
				...
				"User's name: \t" + prop.get("user.name") + "\n"
						...
						"Screen resolution: \t" + String.valueOf(size.width)
						+ "x" + String.valueOf(size.height) + "\n"
						+ "Screen size: \t"
						+ prop.get("screen.resolution").toString()
						+ " PPI (Pixels Per Inch)", "Remote host properties",
