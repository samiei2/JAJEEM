...
public class CustomButtonStudent extends WebButton {
	...
	public void init() {
		try {
			URL inp = CustomButtonStudent.class
					.getResource("/icons/noa_en/buttonBackgroundstudent.png");
			background = ImageIO.read(inp);
			inp = CustomButtonStudent.class
					.getResource("/icons/noa_en/buttondisablestudent.png");
			rollover = ImageIO.read(inp);
			inp = CustomButtonStudent.class
					.getResource("/icons/noa_en/buttonselectstudent.png");
