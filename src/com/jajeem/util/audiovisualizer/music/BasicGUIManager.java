...
import com.jajeem.util.audiovisualizer.graphics.AnimatedNGraph;
import com.jajeem.util.audiovisualizer.graphics.AnimatedNGraphPanel;
import com.jajeem.util.audiovisualizer.graphics.ArrayLineGraphPanel;
import com.jajeem.util.audiovisualizer.graphics.GraphPanel;
import com.jajeem.util.audiovisualizer.graphics.ParticleCloud;
import com.jajeem.util.audiovisualizer.graphics.ParticleLine;
import com.jajeem.util.audiovisualizer.graphics.ScanningLineGraphPanel;
import com.jajeem.util.audiovisualizer.graphics.VerticalPitchGraphPanel;
import com.jajeem.util.audiovisualizer.graphics.VerticalQualityGraphPanel;
import java.awt.Color;
import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;
import com.jajeem.util.audiovisualizer.music.data.DataFrame;
import com.jajeem.util.audiovisualizer.music.data.calc.DPoint;
import com.jajeem.util.audiovisualizer.music.data.calc.NoteConverter;
import com.jajeem.util.audiovisualizer.music.data.calc.PeakPicker;
import com.jajeem.util.audiovisualizer.music.data.calc.Smoother;
import com.jajeem.util.audiovisualizer.music.data.calc.SmootherTwo;
import com.jajeem.util.audiovisualizer.music.data.impl.DirectDataFrame;
