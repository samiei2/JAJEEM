...
//		setExtendedState(JFrame.MAXIMIZED_BOTH);
		...
		gl_panel.setHorizontalGroup(
			gl_panel.createParallelGroup(Alignment.LEADING)
				...
				.addComponent(panelClose, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
		);
		gl_panel.setVerticalGroup(
			gl_panel.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel.createSequentialGroup()
					.addComponent(panelClose, GroupLayout.PREFERRED_SIZE, 49, GroupLayout.PREFERRED_SIZE)
					.addComponent(panelMain, GroupLayout.PREFERRED_SIZE, 810, GroupLayout.PREFERRED_SIZE))
		);
		...
		gl_panelMain.setHorizontalGroup(
			gl_panelMain.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelMain.createSequentialGroup()
					.addGap(24)
					.addComponent(panelContent, GroupLayout.DEFAULT_SIZE, 1550, Short.MAX_VALUE)
					.addGap(26))
		);
		gl_panelMain.setVerticalGroup(
			gl_panelMain.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelMain.createSequentialGroup()
					.addGap(22)
					.addComponent(panelContent, GroupLayout.DEFAULT_SIZE, 824, Short.MAX_VALUE)
					.addGap(23))
		);
		panelMain.setLayout(gl_panelMain);
		
		CustomMainPanel panelCloseButton = new CustomMainPanel("/icons/noa_en/new/closePanel.png");
		GroupLayout gl_panelClose = new GroupLayout(panelClose);
		gl_panelClose.setHorizontalGroup(
			gl_panelClose.createParallelGroup(Alignment.TRAILING)
				.addGroup(Alignment.LEADING, gl_panelClose.createSequentialGroup()
					.addGap(1351)
					.addComponent(panelCloseButton, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE)
		...
		gl_panelClose.setVerticalGroup(
			gl_panelClose.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelClose.createSequentialGroup()
					.addComponent(panelCloseButton, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
					.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
		);
		
		CustomMainButton webButtonMin = new CustomMainButton("/icons/noa_en/new/minbutton",27,27,0,0);
		...
		CustomMainButton webButtonClose = new CustomMainButton("/icons/noa_en/new/closebutton",27,27,0,0);
		...
		CustomMainButton webButtonMax = new CustomMainButton("/icons/noa_en/new/maxbutton",27,27,0,0);
		...
		gl_panelCloseButton.setHorizontalGroup(
			gl_panelCloseButton.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panelCloseButton.createSequentialGroup()
					.addGap(21)
					.addComponent(webButtonMin, GroupLayout.PREFERRED_SIZE, 27, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.RELATED, 23, Short.MAX_VALUE)
					.addComponent(webButtonMax, GroupLayout.PREFERRED_SIZE, 27, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
					.addComponent(webButtonClose, GroupLayout.PREFERRED_SIZE, 27, GroupLayout.PREFERRED_SIZE)
					.addGap(19))
		);
