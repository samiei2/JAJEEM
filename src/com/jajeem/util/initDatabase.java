		...
		try {
			...
			if (s.equals("1")) {
				...
				String query = "CREATE TABLE IF NOT EXISTS QuizReponse (id int DEFAULT 0 NOT NULL AUTO_INCREMENT, answer varchar(555), bool1 boolean, bool2 boolean, bool3 boolean, bool4 boolean, bool5 boolean, answerValid boolean, studentId int NOT NULL, QuizQuestionid int NOT NULL, PRIMARY KEY (id));"
						...
						+ "CREATE TABLE IF NOT EXISTS SurveyQuestion (id int DEFAULT 0 NOT NULL AUTO_INCREMENT, responseId int NOT NULL, title varchar(5000), type tinyint NOT NULL, imagepath varchar(1000), url varchar(555), answer1 varchar(555), answer2 varchar(555), answer3 varchar(555), answer4 varchar(555), answer5 varchar(555), instructorid int NOT NULL, PRIMARY KEY (id));"
				...
				query = "Insert into instructor(username,password,firstname,lastname,language) values('majid','majid','Majid','Ghasemi','none');";
				query += "Insert into instructor(username,password,firstname,lastname,language) values('armin','armin','Armin','Samiei','farsi');";
				query += "Insert into instructor(username,password,firstname,lastname,language) values('mohammad','mohammad','Mohammad','Tahaei','eng');";
				query += "Insert into instructor(username,password,firstname,lastname,language) values('jajeem','jajeem','Jajeem','Jajeem','none');";
				query += "Insert into instructor(username,password,firstname,lastname,language) values('john','john','John','Smith','none');";
