...
public class initDatabase {
	...
	public static void initialize() {
		...
		try {
			...
			String query = "";
			query += "CREATE TABLE IF NOT EXISTS QuizQuestion (Quizid int NOT NULL, id int NOT NULL, title varchar(5000), type tinyint NOT NULL, point int, imagepath varchar(1000), url varchar(555), answer1 varchar(555), answer2 varchar(555), answer3 varchar(555), answer4 varchar(555), answer5 varchar(555), Instructorid2 int NOT NULL, PRIMARY KEY (Quizid, id));"+
					 "CREATE TABLE IF NOT EXISTS QuizRun (Quizid int NOT NULL, Instructorid int NOT NULL, start int, end int, id int NOT NULL, sessionId int NOT NULL, Studentid int NOT NULL, PRIMARY KEY (id, sessionId));"+
					 ...
					 "CREATE TABLE IF NOT EXISTS Reponse (QuizRunid int, QuizRunsessionId int, answer varchar(555), Studentid int NOT NULL, id int GENERATED BY DEFAULT AS IDENTITY, bool1 varchar(5), bool2 varchar(5), bool3 varchar(5), bool4 varchar(5), bool5 varchar(5), PRIMARY KEY (id));"+
