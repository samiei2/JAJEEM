...
class GPanel extends JPanel
{
   ...
   private MultipleGradientPaint.ColorSpaceType cst =
      MultipleGradientPaint.ColorSpaceType.SRGB;

   private MultipleGradientPaint.CycleMethod cm =
   ...
   private void createGradientPaint()
   {
      ...
      Color[] colors = { new Color(77,178,184), new Color(174,215,222), new Color(42,105,87) };
