...
public class LoadingDialog extends JDialog {
	...
	public LoadingDialog() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				LoadingDialog.class.getResource("/icons/noa_en/1.jpg")));
		...
		int scaledWidth, scaledHeight;
		{
			...
			float screenRatio = (float) screenSize.width
			...
			myImage = new ImageIcon(myImage.getImage().getScaledInstance(
		...
		gl_webPanel.setVerticalGroup(gl_webPanel.createParallelGroup(
				...
				gl_webPanel
						...
						.addComponent(wblblStatus, GroupLayout.PREFERRED_SIZE,
