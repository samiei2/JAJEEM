...
public class CustomAccountFrame extends WebFrame {
	...
	public CustomAccountFrame() {
		...
		gl_panel.setHorizontalGroup(gl_panel
				...
				.addComponent(panelContent, GroupLayout.DEFAULT_SIZE, 584,
						Short.MAX_VALUE));
		gl_panel.setVerticalGroup(gl_panel.createParallelGroup(
				Alignment.LEADING).addGroup(
				gl_panel.createSequentialGroup()
						.addComponent(panel_1, GroupLayout.PREFERRED_SIZE, 42,
		...
		gl_panel_1.setHorizontalGroup(gl_panel_1.createParallelGroup(
				...
				gl_panel_1
						...
						.addPreferredGap(ComponentPlacement.RELATED, 175,
								Short.MAX_VALUE)
						.addComponent(panelClose, GroupLayout.PREFERRED_SIZE,
								115, GroupLayout.PREFERRED_SIZE).addGap(31)));
		gl_panel_1
