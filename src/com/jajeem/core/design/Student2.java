...
public class Student2 {
	...
	public Student2() {
		...
		mainFram.setIconImage(Toolkit.getDefaultToolkit().getImage(Student2.class.getResource("/icons/noa_en/logo.png")));
...
//		mainFram.setAlwaysOnTop(true);
	...
	private CustomStudentFrame getMainFrame() {
		return frm;
	}
	...
	public static void setTransmitter(AVTransmit2 transmitter) throws Exception {
		Student2.transmitter = transmitter;
	}
	...
	public static void setReceiverOnly(AVReceiveOnly receiverOnly) {
		Student2.receiverOnly = receiverOnly;
	}
	...
	public static void setStudentModel(
		...
		Student2.studentModel = studentModel;
	}
	...
	public static void setRecordButtonStatic(
		...
		Student2.recordButtonStatic = recordButtonStatic;
	}
