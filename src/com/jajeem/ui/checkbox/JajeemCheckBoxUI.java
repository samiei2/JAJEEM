...
public class JajeemCheckBoxUI extends BasicCheckBoxUI
{
    /**
    ...
    protected void installRolloverListeners ()
    {
        ...
        bgTimer = new WebTimer ( "JajeemCheckBoxUI.bgUpdater", UPDATE_DELAY, new ActionListener ()
        {
            @Override
    ...
    protected void installStateChangeListeners ()
    {
        ...
        checkTimer = new WebTimer ( "JajeemCheckBoxUI.iconUpdater", UPDATE_DELAY, new ActionListener ()
        {
            @Override
            public void actionPerformed ( final ActionEvent e )
            {
...
//        SwingUtils.restoreTextAntialias ( g, hints );
    ...
    protected void paintText ( final Graphics g, final AbstractButton b, final Rectangle textRect, final String text )
    {
        ...
        final FontMetrics fm = checkBox.getFontMetrics ( g.getFont() );
...
//            SwingUtils.drawStringUnderlineCharAt ( g, text, mnemonicIndex, textRect.x - 1, textRect.y + fm.getAscent () - 1 );
    ...
    protected class CheckBoxIcon implements Icon
    {
        ...
        public void paintIcon ( final Component c, final Graphics g, final int x, final int y )
        {
            ...
            JajeemCheckBoxUI.this.paintIcon ( g2d, x, y );
        ...
        public int getIconWidth ()
        {
            return JajeemCheckBoxUI.this.getIconWidth ();
        }
        ...
        public int getIconHeight ()
        {
            return JajeemCheckBoxUI.this.getIconHeight ();
        }
    }
}