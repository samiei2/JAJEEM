...
public class JajeemPasswordTexFieldUI extends BasicTextFieldUI {
	...
	private String inputPrompt = WebPasswordFieldStyle.inputPrompt;
	private Font inputPromptFont = WebPasswordFieldStyle.inputPromptFont;
	private Color inputPromptForeground = WebPasswordFieldStyle.inputPromptForeground;
	private int inputPromptPosition = WebPasswordFieldStyle.inputPromptPosition;
	private boolean hideInputPromptOnFocus = WebPasswordFieldStyle.hideInputPromptOnFocus;
	...
	public JajeemPasswordTexFieldUI(final JPasswordField textField) {
		this(textField, true);
	}

	public JajeemPasswordTexFieldUI(final JPasswordField textField, boolean drawBorder) {
		super();
		this.drawBorder = drawBorder;
		this.textField = textField;
	}

	public JajeemPasswordTexFieldUI(final JPasswordField textField, String uri2) {
		this(textField, true);
		Uri = uri2;
	}
