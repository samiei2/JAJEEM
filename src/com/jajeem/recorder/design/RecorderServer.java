	...
	private void StartFileListenerServer() {
		try {
			...
			JOptionPane
					.showMessageDialog(
							null,
							"An error has occured in recorder server.Recording services might not work correctly,please restart the application!");
		}
	}
