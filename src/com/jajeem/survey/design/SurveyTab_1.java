	...
	public SurveyTab_1(SurveyMain surveyMain) {
					...
					.addGroup(gl_webPanel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_webPanel.createSequentialGroup()
							.addGroup(gl_webPanel.createParallelGroup(Alignment.TRAILING)
								...
								.addComponent(webPanel_1, GroupLayout.PREFERRED_SIZE, 418, Short.MAX_VALUE))
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addGroup(gl_webPanel.createParallelGroup(Alignment.LEADING)
					...
					.addGroup(gl_webPanel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_webPanel.createSequentialGroup()
							...
							.addGroup(gl_webPanel.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_webPanel.createSequentialGroup()
									.addGap(10)
									.addComponent(questionListPanel, GroupLayout.PREFERRED_SIZE, 250, Short.MAX_VALUE)))
							.addPreferredGap(ComponentPlacement.RELATED)
						...
						.addComponent(questionDesignPanel, GroupLayout.DEFAULT_SIZE, 358, Short.MAX_VALUE))
					.addContainerGap())
		);
		...
		groupLayout.setHorizontalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addComponent(webPanel, GroupLayout.PREFERRED_SIZE, 957, Short.MAX_VALUE)
		);
		groupLayout.setVerticalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addComponent(webPanel, GroupLayout.DEFAULT_SIZE, 369, Short.MAX_VALUE)
		);
