			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(groupLayout.createSequentialGroup()
							.addContainerGap()
							.addComponent(webPanel, GroupLayout.PREFERRED_SIZE, 601, Short.MAX_VALUE)))
					.addContainerGap())
		);
		groupLayout.setVerticalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addComponent(webPanel, GroupLayout.PREFERRED_SIZE, 254, Short.MAX_VALUE))
		);
				...
				for (int i = 0; i < surveyResponse.size(); i++) { // iterate
					...
					for (int j = 0; j < surveyResponse.get(i).size(); j++) { // iterate
						...
						if (student.getId() == temps.getId()) {
							...
							model.addRow(new Object[] { tempq.getTitle(),
									StudentOption });
						}
					}
				}
