...
public class TeacherSurveyWindow {
	...
	private void initialize() {
		...
		gl_panelcard2.setHorizontalGroup(gl_panelcard2
				...
				.addGroup(
						gl_panelcard2
								...
								.addComponent(textFieldcard2,
										GroupLayout.PREFERRED_SIZE, 367,
				...
				.addGroup(
						...
						gl_panelcard2
								...
								.addContainerGap()));
		gl_panelcard2
				.setVerticalGroup(gl_panelcard2
						.createParallelGroup(Alignment.LEADING)
						.addGroup(
								gl_panelcard2
										.createSequentialGroup()
		...
		groupLayoutcard2
				.setHorizontalGroup(groupLayoutcard2
						.createParallelGroup(Alignment.LEADING)
						.addGroup(
								groupLayoutcard2
										.createSequentialGroup()
										.addGroup(
												groupLayoutcard2
														...
														.addComponent(
																...
																Short.MAX_VALUE))
										.addGap(1)));
		groupLayoutcard2.setVerticalGroup(groupLayoutcard2.createParallelGroup(
				Alignment.LEADING).addGroup(
				groupLayoutcard2
						.createSequentialGroup()
						.addComponent(panelcard2, GroupLayout.PREFERRED_SIZE,
								79, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(panel_1card2, GroupLayout.DEFAULT_SIZE,
								215, Short.MAX_VALUE)));
		...
		gl_panel_1card2
				.setHorizontalGroup(gl_panel_1card2
						.createParallelGroup(Alignment.LEADING)
						.addGroup(
								gl_panel_1card2
										.createSequentialGroup()
										...
										.addContainerGap()));
		gl_panel_1card2
				.setVerticalGroup(gl_panel_1card2
						.createParallelGroup(Alignment.LEADING)
						.addGroup(
								gl_panel_1card2
										.createSequentialGroup()
										...
										.addPreferredGap(
												ComponentPlacement.RELATED)
										.addComponent(scrollPane_1card2,
		...
		gl_panel_6.setHorizontalGroup(gl_panel_6.createParallelGroup(
				...
				gl_panel_6
						...
						.addGap(151)
						.addComponent(button_2, GroupLayout.PREFERRED_SIZE, 74,
								GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(button_3, GroupLayout.PREFERRED_SIZE, 78,
		...
		comboBoxQuestionType.setModel(new DefaultComboBoxModel(new String[] {
				"Polling", "Text" }));
		...
		gl_panel_2.setHorizontalGroup(gl_panel_2.createParallelGroup(
				...
				gl_panel_2
						.createSequentialGroup()
						.addGap(389)
						.addComponent(panel_4, GroupLayout.DEFAULT_SIZE, 494,
								Short.MAX_VALUE)));
		...
		gl_panel.setVerticalGroup(gl_panel.createParallelGroup(
				...
				gl_panel.createSequentialGroup()
						.addComponent(panel_6, GroupLayout.PREFERRED_SIZE,
								...
								GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(panel_2, GroupLayout.DEFAULT_SIZE, 424,
								Short.MAX_VALUE)));
		...
		gl_panel_1.setHorizontalGroup(gl_panel_1.createParallelGroup(
				...
				gl_panel_1
						...
						.addPreferredGap(ComponentPlacement.RELATED, 650,
