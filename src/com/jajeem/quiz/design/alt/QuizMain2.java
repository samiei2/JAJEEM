...
public class QuizMain2 extends CustomQuizFrame{
	public QuizMain2() {
		...
		CustomQuizButton webButtonAdd = new CustomQuizButton("/icons/noa_en/quizadd.png");
		
		CustomQuizButton webButtonOpen = new CustomQuizButton("/icons/noa_en/quizopen.png");
		
		CustomQuizButton webButtonSave = new CustomQuizButton("/icons/noa_en/quizsave.png");
		
		CustomQuizButton webButtonStart = new CustomQuizButton("/icons/noa_en/quizstart.png");
		
		CustomQuizButton webButtonContent = new CustomQuizButton("/icons/noa_en/quizcontent.png");
		...
		CustomQuizComboBox comboBox = new CustomQuizComboBox("/icons/noa_en/quizcombobox.png");
