...
public class QuizMain2 extends BaseQuizFrame {
	...
	private QuizMain2 mainFrame;
	private List<String> studentIps;
	private int gIndex;
	private WebPanel webPanelCards;

	public QuizMain2(int groupIndex, List<String> list) {
		studentIps = list;
		gIndex = groupIndex;
		currentRun = new Run();
		mainFrame = this;
		...
		gl_panel.setHorizontalGroup(
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addComponent(webScrollPane, GroupLayout.DEFAULT_SIZE, 572, Short.MAX_VALUE)
		);
		gl_panel.setVerticalGroup(
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addComponent(webScrollPane, GroupLayout.DEFAULT_SIZE, 381, Short.MAX_VALUE)
		);
		...
		firstPage = new Quiz_FirstPage(null);
		firstPage.setName("firstPage");
//		secondPage = new Quiz_SecondPage(null);
...
//		webPanelCards.add(secondPage, "secondPage");
	...
	public static void main(String[] args) {
		QuizMain2 main = new QuizMain2(-1, null);
		main.pack();
