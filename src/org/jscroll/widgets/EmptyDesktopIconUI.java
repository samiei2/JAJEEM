...
public class EmptyDesktopIconUI extends DesktopIconUI {
	 ...
	 * 
	 * @param c
	 *            the reference to the JComponent object required by createUI
	 */
	...
	/**
	 * overrides the paint method with a blank routine so that no component is
	 * displayed when an internal frame is iconified
	 * 
	 * @param g
	 *            the reference to the Graphics object used to paint the desktop
	 */
