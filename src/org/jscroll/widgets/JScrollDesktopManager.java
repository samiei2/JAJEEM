...
public class JScrollDesktopManager extends DefaultDesktopManager {
	 ...
	 * 
	 * @param desktopPane
	 *            a reference to RootDesktopPane
	 */
	...
	/**
	 * maximizes the internal frame to the viewport bounds rather than the
	 * desktop bounds
	 * 
	 * @param f
	 *            the internal frame being maximized
	 */
	@Override
	...
	/**
	 * insures that the associated toolbar and menu buttons of the internal
	 * frame are activated as well
	 * 
	 * @param f
	 *            the internal frame being activated
	 */
	@Override
	public void activateFrame(JInternalFrame f) {
		super.activateFrame(f);
		// f.selectFrameAndAssociatedButtons();
	}

	/**
	 * closes the internal frame and removes any associated button and menu
	 * components
	 * 
	 * @param f
	...
	/*
	 * could override iconifyFrame here as well, but much simpler to define an
	 * EmptyDesktopIconUI look and feel class in RootDesktopPane
	 */
}
