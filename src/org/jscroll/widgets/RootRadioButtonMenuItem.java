 ...
 * keyboard shortcut, and title are set via the constructor. <BR>
 * <BR>
 ...
 */
public class RootRadioButtonMenuItem extends JRadioButtonMenuItem implements
	 ...
	 * 
	 * @param listener
	 *            the action listener to assign
	 * @param itemTitle
	 *            the title of the item
	 * @param mnemonic
	 *            the mnemonic used to access the menu
	 * @param shortcut
	 *            the keyboard shortcut used to access the menu. -1 indicates no
	 *            shortcut.
	 * @param selected
	 *            <code>boolean</code> that indicates whether the menu item is
	 *            selected or not
	 * @param associatedFrame
	 *            the JScrollInternalFrame associated with the menu item
	 */
	...
	/**
	 * creates the RootRadioButtonMenuItem without an associated frame. Used for
	 * generic radio button menu items.
	 * 
	 * @param listener
	 *            the action listener to assign
	 * @param itemTitle
