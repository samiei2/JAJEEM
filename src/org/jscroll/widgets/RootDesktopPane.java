 ...
 * desktop manager is set to {@link org.jscroll.widgets.JScrollDesktopManager
 * JScrollDesktopManager}, and the look and feel DesktopIconUI is replaced by
 * the blank icon generator, {@link org.jscroll.widgets.EmptyDesktopIconUI
 * EmptyDesktopIconUI}.
 * 
...
public class RootDesktopPane extends JDesktopPane {
	...
	public RootDesktopPane(DesktopScrollPane desktopScrollpane) {
		this.setDesktopScrollpane(desktopScrollpane);
	 ...
	 * {@link org.jscroll.widgets.DesktopScrollPane DesktopScrollPane} viewport
	 * 
	 * @return the Rectangle object of the viewport
	 */
	public Rectangle getScrollPaneRectangle() {
		return getDesktopScrollpane().getViewport().getViewRect();
	}
	...
	public void removeAssociatedComponents(JScrollInternalFrame f) {
		getDesktopScrollpane().removeAssociatedComponents(f);
	}
