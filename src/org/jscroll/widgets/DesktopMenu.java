...
public class DesktopMenu extends JMenu implements ActionListener {
	 ...
	 *            a reference to the DesktopMediator object
	 * @param tileMode
	 *            the tile mode to use (<code>true</code> = tile internal
	...
	/**
	 * adds a {@link org.jscroll.widgets.RootRadioButtonMenuItem
	 * RootRadioButtonMenuItem} to the menu and associates it with an internal
	 * frame
	 * 
	...
	private void refreshMenu() {
		...
		while (e.hasMoreElements()) {
			RootRadioButtonMenuItem b = (RootRadioButtonMenuItem) e
					.nextElement();
