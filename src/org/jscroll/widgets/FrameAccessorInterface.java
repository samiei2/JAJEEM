 ...
 * required to get and set the internal frame associated with an implementing
 * class. Used by {@link org.jscroll.widgets.DesktopListener DesktopListener} to
 * abstract access to the menu and toggle buttons that implement this interface.
 * 
...
public interface FrameAccessorInterface {
	 ...
	 *            the JScrollInternalFrame to associate with the object
	 */
