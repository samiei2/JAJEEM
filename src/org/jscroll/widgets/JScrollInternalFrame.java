...
/**
 * This class provides a custom internal frame. Each internal frame is assigned
 * an associated toggle button and an optional radio button menu item. These
 * buttons reside in the {@link org.jscroll.widgets.DesktopResizableToolBar
 * DesktopResizableToolBar} and {@link org.jscroll.widgets.DesktopMenu
 * DesktopMenu}. classes respectively.
 * 
 * @author <a href="mailto:tessier@gabinternet.com">Tom Tessier</a>
 * @author <a href="mailto:francesco.furfari@guest.cnuce.cnr.it">Francesco
 *         Furfari</a> <!-- Fran did some small fix, can't remember what -->
...
public class JScrollInternalFrame extends JInternalFrame {
	 ...
	 * 
	 * @param title
	 *            the string displayed in the title bar of the internal frame
	 * @param icon
	 *            the ImageIcon displayed in the title bar of the internal frame
	 * @param frameContents
	 *            the contents of the internal frame
	 * @param isClosable
	 *            determines whether the frame is closable
	 */
	 ...
	 * 
	 * @param associatedMenuButton
	 *            the menu button to associate with the internal frame
	 */
	 ...
	 * 
	 * @return the JRadioButtonMenuItem object associated with this internal
	 *         frame
	 */
	 ...
	 * 
	 * @param associatedButton
	 *            the toggle button to associate with the internal frame
	 */
	 ...
	 * 
	 * @return the Dimension object representing the initial dimensions of this
	 *         internal frame
	 */
	...
	/**
	 * selects the current frame, along with any toggle and menu buttons that
	 ...
	 * frame is added to the JDesktopPane. <BR>
	 * <BR>
	 * Manually-built internal frames won't display properly without this. <BR>
	 * <BR>
	 * Fix by <a href="mailto:francesco.furfari@guest.cnuce.cnr.it">Francesco
	 * Furfari</a>
	 * 
	 */
	@Override
