...
/**
 * This class provides common Component and Action Listeners for other objects
 * in the system.
 * 
...
public class DesktopListener implements ComponentListener, ActionListener {
	...
	/**
	 * common actionPerformed method that responds to both button and menu
	 * events. If no action command provided in the ActionEvent, selects the
	 * frame associated with the current button / menu item (if any).
	 * 
	 * @param e
	 *            the ActionEvent
	 */
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (actionCmd.equals("Tile")) {
			...
			JScrollInternalFrame associatedFrame = ((FrameAccessorInterface) e
					.getSource()).getAssociatedFrame();
