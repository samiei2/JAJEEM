 ...
 * <BR>
 * JScrollDesktopPane builds upon JDesktopPane and JScrollPane to provide a
 ...
 * frames to the JScrollDesktopPane and the registration of menu bars for use by
 * the scrollable desktop is relatively simple: The <code>add</code> method
 * creates a new internal frame and returns a reference to the JInternalFrame
 * instance that was created, while the <code>registerMenuBar</code> method
 * registers the menubar for use by the scrollable desktop. A JMenuBar object
 * may also be registered by passing it as a constructor parameter to the
 * JScrollDesktopPane. <BR>
 * <BR>
 ...
 * </pre></code>
 * 
 * JScrollDesktopPane has been tested under Java 2 JDK versions 1.3.1-b24 on
...
public class JScrollDesktopPane extends JPanel implements DesktopConstants {
	...
	/**
	 * creates the JScrollDesktopPane object, registers a menubar, and assigns a
	 * default internal frame icon.
	 * 
	 * @param mb
	...
	public JScrollDesktopPane() {
		...
		setDesktopMediator(new DesktopMediator(this));
	}
	...
	public JInternalFrame add(String title, ImageIcon icon,
		...
		return getDesktopMediator().add(title, icon, frameContents, isClosable,
				x, y);
	}
	 ...
	 * 
	 * @param f
	 *            the internal frame of class JScrollInternalFrame to add
	 */
	...
	public void registerMenuBar(JMenuBar mb) {
		getDesktopMediator().registerMenuBar(mb);
	}
	...
	public JInternalFrame getSelectedFrame() {
		return getDesktopMediator().getSelectedFrame();
	}
	...
	public void setSelectedFrame(JInternalFrame f) {
		getDesktopMediator().setSelectedFrame(f);
	}
	...
	public void flagContentsChanged(JInternalFrame f) {
		getDesktopMediator().flagContentsChanged(f);
	}
