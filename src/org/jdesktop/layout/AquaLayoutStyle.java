 ...
 * com/documentation/UserExperience/Conceptual/OSXHIGuidelines/
 * 
...
class AquaLayoutStyle extends LayoutStyle {
	...
	private Insets getPreferredGap(JComponent component, int type, int sizeStyle) {
		...
		if (uid == "ButtonUI" || uid == "ToggleButtonUI") {
			...
			style = (((JProgressBar) component).getOrientation() == SwingConstants.HORIZONTAL) ? "horizontal"
					: "vertical";
		} else if (uid == "SliderUI") {
			style = (((JSlider) component).getOrientation() == SwingConstants.HORIZONTAL) ? "horizontal"
					: "vertical";
