 ...
 */
public abstract class AbstractRenderer<T extends Format> extends
		ControlsAdapter implements Renderer {
	/**
	...
	public static void useThreadPriority(int threadPriority) {
		...
		if (throwable != null) {
			logger.warn("Failed to use thread priority: " + threadPriority,
					throwable);
		}
	}
}
