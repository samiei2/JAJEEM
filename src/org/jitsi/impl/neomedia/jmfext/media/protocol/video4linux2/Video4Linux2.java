...
public class Video4Linux2 {
	...
	public static final int V4L2_PIX_FMT_YUV420 = v4l2_fourcc('Y', 'U', '1',
			'2');
	...
	public static native long mmap(long start, int length, int prot, int flags,
			int fd, long offset);
	...
	public static native void v4l2_pix_format_setBytesperline(
			long v4l2_pix_format, int bytesperline);

	public static native void v4l2_pix_format_setField(long v4l2_pix_format,
			int field);

	public static native void v4l2_pix_format_setPixelformat(
			long v4l2_pix_format, int pixelformat);

	public static native void v4l2_pix_format_setWidthAndHeight(
			long v4l2_pix_format, int width, int height);
	...
	public static native void v4l2_requestbuffers_setCount(
			long v4l2_requestbuffers, int count);

	public static native void v4l2_requestbuffers_setMemory(
			long v4l2_requestbuffers, int memory);

	public static native long v4l2_streamparm_alloc(int type);

	public static native void v4l2_streamparm_setFps(long v4l2_streamparm,
			int fps);
