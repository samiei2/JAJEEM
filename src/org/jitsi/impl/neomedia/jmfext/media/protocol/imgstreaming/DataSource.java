...
public class DataSource extends AbstractVideoPullBufferCaptureDevice {
	...
	protected AbstractPullBufferStream createStream(int streamIndex,
		...
		/*
		 * full desktop: remainder => index part of desktop: remainder =>
		 * index,x,y
		 */
	 ...
	 *            <tt>ImageStream</tt> to set the display index and the origin
	 *            of
	 * @param displayIndex
	 *            the display index to set on the specified <tt>ImageStream</tt>
	 * @param x
	 *            the x coordinate of the origin to set on the specified
	 *            <tt>ImageStream</tt>
	 * @param y
	 *            the y coordinate of the origin to set on the specified
	 *            <tt>ImageStream</tt>
	 */
	public void setOrigin(int streamIndex, int displayIndex, int x, int y) {
