...
public class DataSource extends AbstractPullBufferCaptureDevice {
	...
	public DataSource(MediaLocator locator, Format[] supportedFormats,
		...
		this.supportedFormats = (supportedFormats == null) ? null
					...
					for (Object stream : streams) {
						try {
							...
							logger.error("Failed to close "
									+ stream.getClass().getSimpleName(), ioex);
						}
					}
				}
			}
	...
	public static String getDeviceID(MediaLocator locator) {
		...
		} else if (AudioSystem.LOCATOR_PROTOCOL_PORTAUDIO
	...
	protected Format[] getSupportedFormats(int streamIndex) {
		return (supportedFormats == null) ? super
				.getSupportedFormats(streamIndex) : supportedFormats;
	}
}
