 ...
 */
abstract class AbstractBufferStream extends AbstractControls implements
		SourceStream {
	/**
	...
	private static final Logger logger = Logger
			.getLogger(AbstractBufferStream.class);
	 ...
	 */
	protected AbstractBufferStream(DataSource dataSource,
