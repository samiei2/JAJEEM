...
public class DataSource extends AbstractVideoPullBufferCaptureDevice {
	 ...
	 */
	private static final int[] V4L2_TO_FFMPEG_PIX_FMT = new int[] {
			Video4Linux2.V4L2_PIX_FMT_UYVY, FFmpeg.PIX_FMT_UYVY422,
			Video4Linux2.V4L2_PIX_FMT_YUV420, FFmpeg.PIX_FMT_YUV420P,
			Video4Linux2.V4L2_PIX_FMT_YUYV, FFmpeg.PIX_FMT_YUYV422,
			Video4Linux2.V4L2_PIX_FMT_MJPEG, FFmpeg.PIX_FMT_YUVJ422P,
			Video4Linux2.V4L2_PIX_FMT_JPEG, FFmpeg.PIX_FMT_YUVJ422P,
			Video4Linux2.V4L2_PIX_FMT_RGB24, FFmpeg.PIX_FMT_RGB24_1,
	...
	private String getDeviceName() {
		...
		return ((locator != null) && DeviceSystem.LOCATOR_PROTOCOL_VIDEO4LINUX2
				.equalsIgnoreCase(locator.getProtocol())) ? locator
				.getRemainder() : null;
	}
