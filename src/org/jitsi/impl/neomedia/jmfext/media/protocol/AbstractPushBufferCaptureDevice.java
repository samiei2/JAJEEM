 ...
 */
public abstract class AbstractPushBufferCaptureDevice extends
		PushBufferDataSource implements CaptureDevice {
	/**
	...
	private final AbstractBufferCaptureDevice<AbstractPushBufferStream> impl = new AbstractBufferCaptureDevice<AbstractPushBufferStream>() {
		...
		protected FrameRateControl createFrameRateControl() {
			return AbstractPushBufferCaptureDevice.this
		...
		protected AbstractPushBufferStream createStream(int streamIndex,
			...
			return AbstractPushBufferCaptureDevice.this.createStream(
		...
		protected Format getFormat(int streamIndex, Format oldValue) {
			return AbstractPushBufferCaptureDevice.this.getFormat(streamIndex,
					oldValue);
		}
		...
		protected Format setFormat(int streamIndex, Format oldValue,
				Format newValue) {
			return AbstractPushBufferCaptureDevice.this.setFormat(streamIndex,
					oldValue, newValue);
		}
	};
