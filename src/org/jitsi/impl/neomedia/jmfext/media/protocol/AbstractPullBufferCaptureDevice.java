 ...
 */
public abstract class AbstractPullBufferCaptureDevice extends
		PullBufferDataSource implements CaptureDevice {
	...
	private final AbstractBufferCaptureDevice<AbstractPullBufferStream> impl = new AbstractBufferCaptureDevice<AbstractPullBufferStream>() {
		...
		protected FrameRateControl createFrameRateControl() {
			return AbstractPullBufferCaptureDevice.this
		...
		protected AbstractPullBufferStream createStream(int streamIndex,
			...
			return AbstractPullBufferCaptureDevice.this.createStream(
					streamIndex, formatControl);
		}
		...
		protected Format getFormat(int streamIndex, Format oldValue) {
			return AbstractPullBufferCaptureDevice.this.getFormat(streamIndex,
					oldValue);
		}
		...
		@Override
		protected Format setFormat(int streamIndex, Format oldValue,
				Format newValue) {
			return AbstractPullBufferCaptureDevice.this.setFormat(streamIndex,
					oldValue, newValue);
		}
	};
	...
	@Override
	public CaptureDeviceInfo getCaptureDeviceInfo() {
		return (deviceInfo == null) ? AbstractBufferCaptureDevice
				.getCaptureDeviceInfo(this) : deviceInfo;
	}
