...
public class WASAPI {
	...
	static {
		 ...
		 */
		try {
			PKEY_Device_FriendlyName = PSPropertyKeyFromString("{a45c254e-df1c-4efd-8020-67d146a850e0} 14");
	...
	public static native long CoCreateInstance(String clsid, long pUnkOuter,
	...
	public static native long CreateEvent(long lpEventAttributes,
	...
	public static native int IAudioCaptureClient_Read(long thiz, byte[] data,
	...
	public static native int IAudioClient_Initialize(long thiz, int shareMode,
			int streamFlags, long hnsBufferDuration, long hnsPeriodicity,
			long pFormat, String audioSessionGuid) throws HResultException;

	public static native long IAudioClient_IsFormatSupported(long thiz,
			int shareMode, long pFormat) throws HResultException;

	public static native void IAudioClient_Release(long thiz);

	public static native void IAudioClient_SetEventHandle(long thiz,
			long eventHandle) throws HResultException;
	 ...
	 */
	public static native int IAudioRenderClient_Write(long thiz, byte[] data,
			int offset, int length, int srcSampleSize, int srcChannels,
			int dstSampleSize, int dstChannels) throws HResultException;

	public static native long IMMDevice_Activate(long thiz, String iid,
			int dwClsCtx, long pActivationParams) throws HResultException;
	...
	public static native long IMMDevice_OpenPropertyStore(long thiz,
			int stgmAccess) throws HResultException;
	...
	public static native long IMMDeviceEnumerator_EnumAudioEndpoints(long thiz,
			int dataFlow, int dwStateMask) throws HResultException;

	public static native long IMMDeviceEnumerator_GetDevice(long thiz,
			String pwstrId) throws HResultException;
	...
	public static native int WaitForSingleObject(long hHandle,
			long dwMilliseconds) throws HResultException;

	public static native long WAVEFORMATEX_alloc();

	public static native void WAVEFORMATEX_fill(long thiz, char wFormatTag,
	...
	public static native void WAVEFORMATEX_setNAvgBytesPerSec(long thiz,
			int nAvgBytesPerSec);

	public static native void WAVEFORMATEX_setNBlockAlign(long thiz,
			char nBlockAlign);

	public static native void WAVEFORMATEX_setNChannels(long thiz,
			char nChannels);

	public static native void WAVEFORMATEX_setNSamplesPerSec(long thiz,
			int nSamplesPerSec);

	public static native void WAVEFORMATEX_setWBitsPerSample(long thiz,
			char wBitsPerSample);

	public static native void WAVEFORMATEX_setWFormatTag(long thiz,
			char wFormatTag);
