...
/**
 * Defines the interface for controlling <tt>CaptureDevice</tt>s/
 * <tt>DataSource</tt>s associated with the <tt>imgstreaming</tt> FMJ/JMF
 * protocol.
 * 
...
public interface ImgStreamingControl extends Control {
	 ...
	 * 
	 * @param streamIndex
	 *            the index in the associated <tt>DataSource</tt> of the stream
	 *            to set the display index and the origin of
	 * @param displayIndex
