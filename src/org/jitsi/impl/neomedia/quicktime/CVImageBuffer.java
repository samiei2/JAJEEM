...
public class CVImageBuffer {
	...
	/**
	 * Initializes a new <tt>CVImageBuffer</tt> instance which is to represent a
	 * specific CoreVideo <tt>CVImageBufferRef</tt>.
	 * 
	 * @param ptr
	 *            the CoreVideo <tt>CVImageBufferRef</tt> to be represented by
	 *            the new instance
	 */
