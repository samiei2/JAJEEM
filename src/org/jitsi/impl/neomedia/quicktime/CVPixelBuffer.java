...
public class CVPixelBuffer extends CVImageBuffer {
	...
	/**
	 * Initializes a new <tt>CVPixelBuffer</tt> instance which is to represent a
	 * specific CoreVideo <tt>CVPixelBufferRef</tt>.
	 * 
	 * @param ptr
	 *            the CoreVideo <tt>CVPixelBufferRef</tt> to be represented by
	 *            the new instance
	 */
	 ...
	 * 
	 * @param ptr
	 *            the <tt>CVPixelBufferRef</tt> to get the number of bytes which
	 ...
	 * 
	 * @param ptr
	 *            the <tt>CVPixelBufferRef</tt> to get the pixel bytes of
	 * @return a <tt>byte</tt> array which represents the pixels of the
	 ...
	 * 
	 * @param ptr
	 *            the <tt>CVPixelBufferRef</tt> to get the bytes of
	 * @param buf
	 *            the native byte buffer to return the bytes into
	 * @param bufLength
	 *            the capacity in bytes of <tt>buf</tt>
	 ...
	 * 
	 * @param ptr
	 *            the CoreVideo <tt>CVPixelBufferRef</tt> to get the height in
	 *            pixels of
	 ...
	 * 
	 * @param ptr
	 *            the CoreVideo <tt>CVPixelBufferRef</tt> to get the width in
	 *            pixels of
	 ...
	 *            destination array
	 * @param dstOffset
	 *            offset of <tt>dst</tt> to copy data to
	 * @param dstLength
	 *            length of <tt>dst</tt>
	 * @param src
	 *            native pointer source
	 */
	public static native void memcpy(byte[] dst, int dstOffset, int dstLength,
			long src);
}
