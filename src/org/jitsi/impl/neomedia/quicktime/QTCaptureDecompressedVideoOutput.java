...
public class QTCaptureDecompressedVideoOutput extends QTCaptureOutput {
	 ...
	 *            <tt>QTCaptureDecompressedVideoOutput</tt> object to be
	 ...
	 *         <tt>QTCaptureDecompressedVideoOutput</tt> will output consecutive
	 *         video frames. It is equivalent to the inverse of the maximum
	 *         frame rate. The value of <tt>0</tt> indicates an unlimited
	 *         maximum frame rate.
	 */
	 ...
	 * 
	 * @param ptr
	 *            a pointer to the <tt>QTCaptureDecompressedVideoOutput</tt>
	 *            instance to get the minimum time interval between consecutive
	 *            video frame output of
	 * @return the minimum time interval between which a specific
	 *         <tt>QTCaptureDecompressedVideoOutput</tt> instance will output
	 *         consecutive video frames. It is equivalent to the inverse of the
	 *         maximum frame rate. The value of <tt>0</tt> indicates an
	...
	public NSDictionary pixelBufferAttributes() {
		...
		return (pixelBufferAttributesPtr == 0) ? null : new NSDictionary(
	...
	public boolean setAutomaticallyDropsLateVideoFrames(
		...
		return setAutomaticallyDropsLateVideoFrames(getPtr(),
				automaticallyDropsLateVideoFrames);
	}

	private static native boolean setAutomaticallyDropsLateVideoFrames(
			long ptr, boolean automaticallyDropsLateVideoFrames);
	 ...
	 *            the minimum time interval between which this
	 *            <tt>QTCaptureDecompressedVideoOutput</tt> is to output
	 *            consecutive video frames. It is equivalent to the inverse of
	 *            the maximum frame rate. The value of <tt>0</tt> indicates an
	 ...
	 * @param ptr
	 *            a pointer to the <tt>QTCaptureDecompressedVideoOutput</tt>
	 *            instance to set the minimum time interval between consecutive
	 *            video frame output on
	 * @param minimumVideoFrameInterval
	 *            the minimum time interval between which a specific
	 *            <tt>QTCaptureDecompressedVideoOutput</tt> instance is to
	 *            output consecutive video frames. It is equivalent to the
	 *            inverse of the maximum frame rate. The value of <tt>0</tt>
	 *            indicates an unlimited frame rate.
	 */
	...
	private static native void setPixelBufferAttributes(long ptr,
	...
	public static abstract class Delegate {
		 ...
		 * 
		 * @param videoFrame
		 *            the <tt>CVImageBuffer</tt> which represents the output
		 *            video frame
		 * @param sampleBuffer
		 *            the <tt>QTSampleBuffer</tt> which represents additional
		 *            details about the output video samples
		 */
	...
	private static class MutableCVPixelBuffer extends CVPixelBuffer {
		 ...
		 * 
		 * @param ptr
		 *            the CoreVideo <tt>CVPixelBufferRef</tt> to be represented
		 *            by the new instance
		 */
