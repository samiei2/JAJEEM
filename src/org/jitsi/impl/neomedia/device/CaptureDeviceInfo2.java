...
public class CaptureDeviceInfo2 extends CaptureDeviceInfo {
	...
	public CaptureDeviceInfo2(CaptureDeviceInfo captureDeviceInfo, String uid,
		...
		this(captureDeviceInfo.getName(), captureDeviceInfo.getLocator(),
				captureDeviceInfo.getFormats(), uid, transportType,
				modelIdentifier);
	}
	 ...
	 *            to be represented by the new instance
	 */
	public CaptureDeviceInfo2(String name, MediaLocator locator,
			Format[] formats, String uid, String transportType,
	...
	public boolean isSameTransportType(String transportType) {
		return (this.transportType == null) ? (transportType == null)
