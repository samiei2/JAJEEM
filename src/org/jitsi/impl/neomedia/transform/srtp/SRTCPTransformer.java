...
public class SRTCPTransformer implements PacketTransformer {
	 ...
	 */
	public SRTCPTransformer(SRTPContextFactory forwardFactory,
	...
	public void close() {
		synchronized (contexts) {
			...
			Iterator<Map.Entry<Long, SRTCPCryptoContext>> iter = contexts
					.entrySet().iterator();
	...
	private SRTCPCryptoContext getContext(RawPacket pkt,
