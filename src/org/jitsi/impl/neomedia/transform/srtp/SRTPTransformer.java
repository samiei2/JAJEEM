...
public class SRTPTransformer implements PacketTransformer {
	 ...
	 */
	public SRTPTransformer(SRTPContextFactory forwardFactory,
	...
	public void close() {
		synchronized (contexts) {
			...
			Iterator<Map.Entry<Long, SRTPCryptoContext>> iter = contexts
					.entrySet().iterator();
	...
	private SRTPCryptoContext getContext(long ssrc, SRTPContextFactory engine,
	...
	public RawPacket reverseTransform(RawPacket pkt) {
		...
		SRTPCryptoContext context = getContext(pkt.getSSRC(), reverseFactory,
				pkt.getSequenceNumber());

		return ((context != null) && context.reverseTransformPacket(pkt)) ? pkt
				: null;
	}
