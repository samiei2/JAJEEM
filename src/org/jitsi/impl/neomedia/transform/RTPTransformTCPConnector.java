...
public class RTPTransformTCPConnector extends RTPConnectorTCPImpl {
	...
	protected TransformTCPInputStream createControlInputStream()
			throws IOException {
		TransformTCPInputStream controlInputStream = new TransformTCPInputStream(
				getControlSocket());
	...
	protected TransformTCPOutputStream createControlOutputStream()
			throws IOException {
		TransformTCPOutputStream controlOutputStream = new TransformTCPOutputStream(
				getControlSocket());
	...
	protected TransformTCPInputStream createDataInputStream()
			throws IOException {
		TransformTCPInputStream dataInputStream = new TransformTCPInputStream(
				getDataSocket());
	...
	protected TransformTCPOutputStream createDataOutputStream()
			throws IOException {
		TransformTCPOutputStream dataOutputStream = new TransformTCPOutputStream(
				getDataSocket());
