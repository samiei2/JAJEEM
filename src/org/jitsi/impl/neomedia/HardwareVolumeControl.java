...
public class HardwareVolumeControl extends BasicVolumeControl {
	...
	private static final Logger logger = Logger
			.getLogger(HardwareVolumeControl.class);
	...
	protected String getCaptureDeviceUID() {
		AudioSystem audioSystem = mediaServiceImpl.getDeviceConfiguration()
				.getAudioSystem();
		CaptureDeviceInfo2 captureDevice = (audioSystem == null) ? null
