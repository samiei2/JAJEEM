...
public class RecorderImpl implements Recorder {
	...
	public static final String[] SUPPORTED_FORMATS = new String[] {
			...
			SoundFileUtils.mp3, SoundFileUtils.wav };
	 ...
	 */
	@Override
	public void start(String format, String filename) throws IOException,
			MediaException {
		if (this.sink == null) {
			if (format == null) {
			...
			try {
				deviceSession
						.setContentDescriptor(getContentDescriptor(format));
			...
			try {
				DataSource outputDataSource = deviceSession
						.getOutputDataSource();
		...
		if (sink != null) {
			...
			synchronized (this.listeners) {
				listeners = this.listeners
						.toArray(new Recorder.Listener[this.listeners.size()]);
			}
