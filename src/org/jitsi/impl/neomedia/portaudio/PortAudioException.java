...
public class PortAudioException extends Exception {
	...
	public PortAudioException(String message, long errorCode, int hostApiType) {
		...
		this.hostApiType = (hostApiType < 0) ? null : Pa.HostApiTypeId
				.valueOf(hostApiType);
	}
	...
	public String toString() {
		...
		String errorCodeStr = (errorCode == Pa.paNoError) ? null : Long
				.toString(errorCode);

		Pa.HostApiTypeId hostApiType = getHostApiType();
		String hostApiTypeStr = (hostApiType == null) ? null : hostApiType
				.toString();
