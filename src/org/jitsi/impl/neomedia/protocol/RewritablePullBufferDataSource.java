 ...
 */
public class RewritablePullBufferDataSource extends
		PullBufferDataSourceDelegate<PullBufferDataSource> implements
	...
	public PullBufferStream[] getStreams() {
		...
		if (streams != null) {
			for (int streamIndex = 0; streamIndex < streams.length; streamIndex++) {
				streams[streamIndex] = new MutePullBufferStream(
						streams[streamIndex]);
			}
		}
		return streams;
	 ...
	 * support for the wrapped instance.
	 */
	private class MutePullBufferStream extends
			SourceStreamDelegate<PullBufferStream> implements PullBufferStream {
