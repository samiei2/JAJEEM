 ...
 */
public abstract class BufferStreamAdapter<T extends SourceStream> implements
		SourceStream {
	 ...
	 */
	protected void read(Buffer buffer, byte[] bytes) throws IOException {
		int offset = 0;
	 ...
	 * @param offset
	 *            the offset in the specified <tt>buffer</tt> at which writing
