...
public class TranscodingDataSource extends DataSource {
	 ...
	 *            in a specific outptu <tt>Format</tt>
	 * @param outputFormat
		...
		if (trackControls != null) {
			for (TrackControl trackControl : trackControls) {
				...
				if ((trackFormat instanceof AudioFormat)
					...
					Format[] supportedTrackFormats = trackControl
							.getSupportedFormats();
	...
	public synchronized String getContentType() {
		return (outputDataSource == null) ? null : outputDataSource
				.getContentType();
	}
	...
	public synchronized Object[] getControls() {
		return (outputDataSource == null) ? ControlsAdapter.EMPTY_CONTROLS
	...
	public synchronized Time getDuration() {
		return (outputDataSource == null) ? DURATION_UNKNOWN : outputDataSource
				.getDuration();
	}
