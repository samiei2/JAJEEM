...
public class FFmpeg {
	 ...
	 *         buffer
	 */
	public static native int avcodec_encode_audio(long ctx, byte[] buf,
			int buf_offset, int buf_size, byte[] samples, int samples_offset);
	 ...
	 */
	public static native int avcodec_open2(long ctx, long codec,
			String... options);
	 ...
	 * 
	 * @param ctx
	 *            the <tt>AVCodecContext</tt> to set the gop size of
	 * @param gop_size
	 *            key frame interval
	 */
	...
	public static native void avcodeccontext_set_quantizer(long ctx, int qmin,
			int qmax, int max_qdiff);
	...
	public static native void avcodeccontext_set_sample_aspect_ratio(long ctx,
			int num, int den);

	public static native void avcodeccontext_set_sample_fmt(long ctx,
			int sample_fmt);
	 ...
	 *            <tt>AVCodecContext</tt>
	 */
	public static native void avcodeccontext_set_sample_rate(long ctx,
			int sample_rate);
	 ...
	 * @return <tt>0</tt> on success; a negative <tt>AVERROR</tt> on error
	 */
	public static native int avfilter_graph_parse(long graph, String filters,
			long inputs, long outputs, long log_ctx);
	...
	public static native long get_filtered_video_frame(long input, int width,
			int height, int pixFmt, long buffer, long ffsink, long output);
	 ...
	 */
	public static native long sws_getCachedContext(long ctx, int srcW,
			int srcH, int srcFormat, int dstW, int dstH, int dstFormat,
			int flags);
	 ...
	 * @return 0 if success, -1 otherwise
	 */
	public static native int sws_scale(long ctx, long src, int srcSliceY,
			int srcSliceH, Object dst, int dstFormat, int dstW, int dstH);
	 ...
	 * @return 0 if success, -1 otherwise
	 */
	public static native int sws_scale(long ctx, Object src, int srcFormat,
			int srcW, int srcH, int srcSliceY, int srcSliceH, Object dst,
			int dstFormat, int dstW, int dstH);
}
