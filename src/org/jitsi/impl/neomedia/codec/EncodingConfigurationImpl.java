...
public class EncodingConfigurationImpl extends EncodingConfiguration {
	...
	private void initializeFormatPreferences() {
		...
		// video
		setEncodingPreference("H264", VideoMediaFormatImpl.DEFAULT_CLOCK_RATE,
				1100);

		setEncodingPreference("H263-1998",
				VideoMediaFormatImpl.DEFAULT_CLOCK_RATE, 0);
		 ...
		 */
		setEncodingPreference("JPEG", VideoMediaFormatImpl.DEFAULT_CLOCK_RATE,
				950);
		setEncodingPreference("H261", VideoMediaFormatImpl.DEFAULT_CLOCK_RATE,
				800);
	 ...
	 */
	@Override
	protected void setEncodingPreference(String encoding, double clockRate,
			int pref) {
		...
		if (mediaFormat != null) {
			encodingPreferences
					.put(getEncodingPreferenceKey(mediaFormat), pref);
		}
	}
