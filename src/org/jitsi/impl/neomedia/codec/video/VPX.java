...
public class VPX {
	 ...
	 */
	public static native int codec_dec_init(long context, int iface, long cfg,
			long flags);
	 ...
	 *         {@link VPX#codec_err_to_string(int)}
	 */
	public static native int codec_decode(long context, byte[] buf,
			int buf_offset, int buf_size, long user_priv, long deadline);
	 ...
	 *         {@link VPX#codec_err_to_string(int)}
	 */
	public static native int codec_get_mem_map(long context, long mmap[],
			long[] iter);
	 ...
	 *         {@link VPX#codec_err_to_string(int)}
	 */
	public static native int codec_set_mem_map(long context, long mmap,
			int count);
	 ...
	 *         {@link VPX#codec_err_to_string(int)}
	 */
	public static native int codec_enc_init(long context, int iface, long cfg,
			long flags);
	 ...
	 *         {@link VPX#codec_err_to_string(int)}
	 */
	public static native int codec_encode(long context, long img, byte[] buf,
			int offset0, int offset1, int offset2, long pts, long duration,
	 ...
	 */
	public static native void img_wrap(long img, int fmt, int d_w, int d_h,
			int align, long data);
	 ...
	 *         {@link VPX#codec_err_to_string(int)}
	 */
	public static native int codec_enc_config_default(int iface, long cfg,
			int usage);
	 ...
	 *         {@link VPX#codec_err_to_string(int)}
	 */
	public static native int codec_peek_stream_info(int iface, byte[] buf,
			int buf_offset, int buf_size, long si_ptr);
	 ...
	 */
	public static native int codec_err_to_string(int err, byte[] buf,
			int buf_size);
