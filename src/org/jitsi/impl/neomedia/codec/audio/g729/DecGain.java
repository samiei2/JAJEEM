...
class DecGain {
	 ...
	 */
	/*
	 * File : DEC_GAIN.C Used for the floating point version of both G.729 main
	 * body and G.729A
	 */
	 ...
	 * 
	 * @param index
	 *            input : quantizer index
	 * @param code
	 *            input : fixed code book vector
	 * @param l_subfr
	 *            input : subframe size
	 * @param bfi
	 *            input : bad frame indicator good = 0
	 * @param gain_pit
	 *            output: quantized acb gain
	 * @param gain_code
	 *            output: quantized fcb gain
	 */
	void dec_gain(int index, float code[], int l_subfr, int bfi,
			FloatReference gain_pit, FloatReference gain_code) {
