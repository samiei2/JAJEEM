...
class Lspgetq {
	...
	/*
	 * File : LSPGETQ.C Used for the floating point version of both G.729 main
	 * body and G.729A
	 */
	 ...
	 * @param code0
	 *            input : selected code of first stage
	 * @param code1
	 *            input : selected code of second stage
	 * @param code2
	 *            input : selected code of second stage
	 * @param fg
	 ...
	 */
	static void lsp_get_quant(float lspcb1[][/* M */], float lspcb2[][/* M */],
			int code0, int code1, int code2, float fg[][/* M */],
			float freq_prev[][/* M */], float lspq[], float fg_sum[]) {
	 ...
	 */
	private static void lsp_prev_compose(float lsp_ele[], float lsp[],
			float fg[][/* M */], float freq_prev[][/* M */], float fg_sum[]) {
		int M = Ld8k.M;
	 ...
	 */
	static void lsp_prev_extract(float lsp[/* M */], float lsp_ele[/* M */],
			float fg[/* MA_NP */][/* M */], float freq_prev[/* MA_NP */][/* M */],
			float fg_sum_inv[/* M */]) {
		int M = Ld8k.M;
		int MA_NP = Ld8k.MA_NP;
	 ...
	 */
	static void lsp_prev_update(float lsp_ele[/* M */],
