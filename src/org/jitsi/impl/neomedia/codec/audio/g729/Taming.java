...
class Taming {
	...
	/*
	 * File : TAMING.C Used for the floating point version of both G.729 main
	 * body and G.729A
	 */
	...
	/**
	 * Computes the accumulated potential error in the adaptive codebook
	 * contribution
	 * 
	 * @param t0
	...
	/**
	 * Maintains the memory used to compute the error function due to an
	 * adaptive codebook mismatch between encoder and decoder
	 * 
	 * @param gain_pit
	 *            (i) pitch gain
	 * @param t0
