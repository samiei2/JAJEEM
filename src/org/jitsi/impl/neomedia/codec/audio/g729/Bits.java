...
class Bits {
	...
	/*
	 * File : BITS.C Used for the floating point version of both G.729 main body
	 * and G.729A
	 */
	 ...
	 */
	private static void int2bin(int value, int no_of_bits, short[] bitstream,
	 ...
	 */
	static void bits2prm_ld8k(short bits[], int bits_offset, int prm[],
			int prm_offset) {
		int PRM_SIZE = Ld8k.PRM_SIZE;
		int[] bitsno = TabLd8k.bitsno;
	 ...
	 * @param bitstream
	 *            input : array containing bits
	 * @param bitstream_offset
	 *            input : array offset
	 * @return decimal value of bit pattern
	 */
	private static int bin2int(int no_of_bits, short[] bitstream,
			int bitstream_offset) {
		short BIT_1 = Ld8k.BIT_1;
