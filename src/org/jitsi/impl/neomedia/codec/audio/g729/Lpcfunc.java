...
class Lpcfunc {
	...
	/*
	 * File : LPCFUNC.C Used for the floating point version of G.729 main body
	 * (not for G.729A)
	 */
	 ...
	 *            input : lsp[0:M-1]
	 * @param a
	 *            output: predictor coeffs a[0:M], a[0] = 1.
	 * @param a_offset
	 *            input: predictor coeffs a offset.
	 */
	 ...
	 * @param f
	 *            output: the coefficients of F1 or F2
	 */
	 ...
	 * @param lsf
	 *            output: lsf (normalized frequencies
	 * @param m
	 *            input: length
	 */
	 ...
	 *            input : filter order
	 * @param ap
	 *            output: weighted coefficients ap[0:m]
	 */
	static void weight_az(float[] a, int a_offset, float gamma, int m,
			float[] ap) {
		float fac;
		int i;
	 ...
	 * @param lsp_new
	 *            input : LSPs for present frame (0:M-1)
	 * @param az
	 *            output: filter parameters in 2 subfr (dim 2(m+1))
	 */
	 ...
	 * @param lsf_new
	 *            input : LSFs for present frame (0:M-1)
	 * @param az
	 *            output: filter parameters in 2 subfr (dim 2(m+1))
	 */
	static void int_lpc(float lsp_old[], float lsp_new[], float lsf_int[],
			float lsf_new[], float az[]) {
		int M = Ld8k.M;
