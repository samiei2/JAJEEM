...
class Pitch {
	...
	/*
	 * File : PITCH.C Used for the floating point version of G.729 main body
	 * (not for G.729A)
	 */
	 ...
	 * 
	 * @param signal
	 *            input : signal to compute pitch s[-PIT_MAX : l_frame-1]
	 * @param signal_offset
	 *            input : signal offset
	 * @param pit_min
	 *            input : minimum pitch lag
	 * @param pit_max
	 *            input : maximum pitch lag
	 * @param l_frame
	 *            input : error minimization window
	 * @return open-loop pitch lag
	 */
	static int pitch_ol(float[] signal,

	int signal_offset, int pit_min, int pit_max, int l_frame) {
	 ...
	 * @return lag found
	 */
	private static int lag_max(float[] signal, int signal_offset, int l_frame,
			int lagmax, int lagmin, FloatReference cor_max) {
	 ...
	 * @param exc_offset
	 *            input : excitation buffer offset
	 * @param xn
	 *            input : target vector
	 * @param h
	 *            input : impulse response of filters.
	 * @param l_subfr
	 *            input : Length of frame to compute pitch
	 * @param t0_min
	 *            input : minimum value in the searched range
	 * @param t0_max
	 *            input : maximum value in the searched range
	 * @param i_subfr
	 *            input : indicator for first subframe
	 * @param pit_frac
	 *            output: chosen fraction
	 * @return integer part of pitch period
	 */
	static int pitch_fr3(float[] exc, /*                  */
			int exc_offset, float xn[], /*                        */
			float h[], /*        */
			int l_subfr, /*     */
			int t0_min, /*  */
			int t0_max, /*  */
		...
		norm_corr(exc, exc_offset, xn, h, l_subfr, t_min, t_max, corr,
				corr_offset);
	 ...
	 *            input : Length of frame to compute pitch
	 * @param t_min
	 *            input : minimum value of searched range
	 * @param t_max
	 *            input : maximum value of search range
	 * @param corr_norm
	 *            output: normalized correlation (correlation between target and
	 *            filtered excitation divided by the square root of energy of
	 *            filtered excitation)
	 * @param corr_norm_offset
	 *            input: normalized correlation offset
	 */
	private static void norm_corr(float[] exc, int exc_offset, float xn[],
			float h[], int l_subfr, int t_min, int t_max, float corr_norm[],
	 ...
	 */
	static int enc_lag3(int T0, int T0_frac, IntReference T0_min,
			IntReference T0_max, int pit_min, int pit_max, int pit_flag) {
		int index;
