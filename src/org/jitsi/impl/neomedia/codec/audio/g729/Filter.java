...
class Filter {
	...
	/*
	 * File : FILTER.C Used for the floating point version of both G.729 main
	 * body and G.729A
	 */
	 ...
	 * @param x_offset
	 *            input : input vector offset
	 * @param h
	 *            input : impulse response or second input h[0:l]
	 * @param y
	 *            output: x convolved with h , y[0:l]
	 * @param l
	 *            input : dimension of all vectors
	 */
	 ...
	 * @param a_offset
	 *            input : predictor coefficients a offset
	 * @param x
	 *            input : excitation signal
	 * @param x_offset
	 *            input : excitation signal offset
	 * @param y
	 ...
	 * @param mem
	 *            in/out: filter memory
	 * @param mem_offset
	 *            input : filter memory ofset
	 * @param update
	 *            input : 0 = no memory update, 1 = update
	 */
	static void syn_filt(float a[], int a_offset, float x[], int x_offset,
			float y[], int y_offset, int l, float mem[], int mem_offset,
			int update) {
	 ...
	 * 
	 * @param a
	 *            input : prediction coefficients a[0:m+1], a[0]=1.
	 * @param a_offset
	 *            input : prediction coefficients a offset
	 * @param x
	 *            input : input signal x[0:l-1], x[-1:m] are needed
	 * @param x_offset
	 *            input : input signal x offset
	 * @param y
	 *            output: output signal y[0:l-1]. NOTE: x[] and y[] cannot point
	 *            to same array
	 * @param y_offset
	 *            input : output signal y offset
	 * @param l
	 *            input : dimension of x and y
	 */
	static void residu(float[] a, int a_offset, float[] x, int x_offset,
			float[] y, int y_offset, int l) {
		int M = Ld8k.M;
