...
public class Opus {
	 ...
	 */
	public static native int decode(long decoder, byte[] input,
			int inputOffset, int inputLength, byte[] output, /* int outputOffset, */
			int outputFrameSize, int decodeFEC);
	 ...
	 */
	public static native int decoder_get_nb_samples(long decoder,
	 ...
	 *         error.
	 */
	public static native int encode(long encoder, byte[] input,
			int inputOffset, int inputFrameSize, byte[] output, /*
																 * int
																 * outputOffset,
																 */
			int outputLength);
