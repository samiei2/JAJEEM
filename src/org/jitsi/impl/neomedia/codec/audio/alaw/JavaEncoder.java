...
public class JavaEncoder extends com.ibm.media.codec.audio.AudioCodec {
	...
	public JavaEncoder() {
		...
		defaultOutputFormats = new AudioFormat[] { new AudioFormat(
				AudioFormat.ALAW, 8000, 8, 1, Format.NOT_SPECIFIED,
	...
	protected Format[] getMatchingOutputFormats(Format in) {
		...
		supportedOutputFormats = new AudioFormat[] { new AudioFormat(
				AudioFormat.ALAW, sampleRate, 8, 1, Format.NOT_SPECIFIED,
				Format.NOT_SPECIFIED) };
	...
	public int process(Buffer inputBuffer, Buffer outputBuffer) {
		...
		aLawEncode(bigEndian, inpData, inputBuffer.getOffset(),
				inputBuffer.getLength(), outData);
