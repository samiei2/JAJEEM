...
/**
 * Insertion sort (fast for already almost sorted arrays): Best case: O(n) for
 * an already sorted array Worst case: O(n^2) for an inversely sorted array
...
public class Sort {
	...
	static void SKP_Silk_shell_insertion_sort_increasing(int[] a, /*
		...
		while (inc > 0) {
			...
			// inc_Q16_tmp = SKP_SMULWB( inc_Q16_tmp, 29789 ); // 29789_Q16 =
			// 2.2^(-1)_Q0
			inc_Q16_tmp = Macros.SKP_SMULWB(inc_Q16_tmp, 29789); // 29789_Q16 =
																	// 2.2^(-1)_Q0
