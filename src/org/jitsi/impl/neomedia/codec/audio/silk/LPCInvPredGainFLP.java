...
public class LPCInvPredGainFLP {
	...
	/**
	 * compute inverse of LPC prediction gain, and test if LPC coefficients are
	 * stable (all poles within unit circle) this code is based on
	 * SKP_Silk_a2k_FLP().
	 * 
	 * @param invGain
	 ...
	 */
	static int SKP_Silk_LPC_inverse_pred_gain_FLP( /*
	...
	float[] invGain, /* O: inverse prediction gain, energy domain */
		...
		float[][] Atmp = new float[2][SigProcFIXConstants.SKP_Silk_MAX_ORDER_LPC];
		float[] Aold, Anew;
