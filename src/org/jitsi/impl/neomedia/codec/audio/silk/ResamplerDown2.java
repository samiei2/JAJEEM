...
public class ResamplerDown2 {
	 ...
	 */
	static void SKP_Silk_resampler_down2(int[] S, /* I/O: State vector [ 2 ] */
			int S_offset, short[] out, /* O: Output signal [ len ] */
			int out_offset, short[] in, /* I: Input signal [ floor(len/2) ] */
