...
public class Define {
	...
	/*
	 * 30000000 -> 6 sec if bitrate is 5000 bps below limit; 3 sec if bitrate is
	 * 10000 bps below limit
	 */
	...
	static final int SKP_SILK_MORE_FRAMES = 1; /*
												 * More frames to follow this
												 * one
												 */
	static final int SKP_SILK_LBRR_VER1 = 2; /*
											 * LBRR information from packet n -
											 * 1
											 */
	...
	static final int HP_8_KHZ_THRES = 10; /*
										 * average energy per sample, above 8
										 * kHz
										 */
	...
	/*
	 * Max number of bytes in payload output buffer (may contain multiple
	 * frames)
	 */
	...
	static final int MAX_MATRIX_SIZE = MAX_LPC_ORDER; /*
													 * Max of LPC Order and LTP
													 * order
													 */
	...
	/*
	 * Based on above defines, calculate how much memory is necessary to
	 * allocate
	 */
	static int NLSF_MSVQ_TREE_SEARCH_MAX_VECTORS_EVALUATED_LC_MODE() {
		if (NLSF_MSVQ_MAX_VECTORS_IN_STAGE > (MAX_NLSF_MSVQ_SURVIVORS_LC_MODE * NLSF_MSVQ_MAX_VECTORS_IN_STAGE_TWO_TO_END)) {
			...
			return MAX_NLSF_MSVQ_SURVIVORS_LC_MODE
	...
	static int NLSF_MSVQ_TREE_SEARCH_MAX_VECTORS_EVALUATED() {
		if (NLSF_MSVQ_MAX_VECTORS_IN_STAGE > (MAX_NLSF_MSVQ_SURVIVORS * NLSF_MSVQ_MAX_VECTORS_IN_STAGE_TWO_TO_END)) {
			...
			return MAX_NLSF_MSVQ_SURVIVORS
					* NLSF_MSVQ_MAX_VECTORS_IN_STAGE_TWO_TO_END;
		}
	}
	...
	static final int TRANSITION_TIME_UP_MS = 5120; // 5120 = 64 *
													// FRAME_LENGTH_MS * (
													// TRANSITION_INT_NUM - 1 )
													// = 64*(20*4)
	static final int TRANSITION_TIME_DOWN_MS = 2560; // 2560 = 32 *
														// FRAME_LENGTH_MS * (
														// TRANSITION_INT_NUM -
														// 1 ) = 32*(20*4)
