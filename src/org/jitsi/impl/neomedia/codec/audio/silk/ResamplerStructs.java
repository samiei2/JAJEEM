...
public class ResamplerStructs {
	/**
	 * Flag to enable support for input/output sampling rates above 48 kHz. Turn
	 * off for embedded devices.
	 */
...
class SKP_Silk_resampler_state_struct {
	int[] sIIR = new int[ResamplerStructs.SKP_Silk_RESAMPLER_MAX_IIR_ORDER]; /*
																			 * this
																			 * must
																			 * be
																			 * the
	...
	void resampler_function(Object state, short[] out, int out_offset,
			short[] in, int in_offset, int len) {
		resamplerCB.resampler_function(state, out, out_offset, in, in_offset,
				len);
	}
	...
	void up2_function(int[] state, short[] out, int out_offset, short[] in,
			int in_offset, int len) {
	...
	void down_pre_function(int[] state, short[] out, int out_offset,
			short[] in, int in_offset, int len) {
	...
	void up_post_function(int[] state, short[] out, int out_offset, short[] in,
			int in_offset, int len) {
