...
class SKP_Silk_predict_state_FLP {
	...
	float[] prev_NLSFq = new float[Define.MAX_LPC_ORDER]; /*
...
class SKP_Silk_NLSF_CBS_FLP {
	...
	public SKP_Silk_NLSF_CBS_FLP(int nVectors, float[] CB, int CB_offset,
			float[] Rates, int Rates_offset) {
		this.nVectors = nVectors;
...
class SKP_Silk_encoder_state_FLP {
	// SKP_Silk_encoder_state sCmn; /* Common struct, shared with fixed-point
	// code */
	...
	/*
	 * Function pointer to noise shaping quantizer (will be set to SKP_Silk_NSQ
	 * or SKP_Silk_NSQ_del_dec)
	 */
	// void (* NoiseShapingQuantizer)( SKP_Silk_encoder_state *,
	// SKP_Silk_encoder_control *, SKP_Silk_nsq_state *, const SKP_int16 *,
	// SKP_int8 *, const SKP_int, const SKP_int16 *, const SKP_int16 *, const
	// SKP_int16 *, const SKP_int *,
	// const SKP_int *, const SKP_int32 *, const SKP_int32 *, SKP_int, const
	// SKP_int
	// );
	...
	void NoiseShapingQuantizer(SKP_Silk_encoder_state psEnc,
			...
			final short[] x, byte[] q, final int arg6, final short[] arg7,
			final short[] arg8, final short[] arg9, final int[] arg10,
			final int[] arg11, final int[] arg12, final int[] arg13, int arg14,
			final int arg15) {
		noiseShapingQuantizerCB.NoiseShapingQuantizer(psEnc, psEncCtrl, NSQ, x,
				q, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14,
				arg15);
	}

	/* Buffer for find pitch and noise shape analysis */
	float[] x_buf = new float[2 * Define.MAX_FRAME_LENGTH + Define.LA_SHAPE_MAX];/*
																				 * Buffer
																				 * for
																				 * find
																				 * pitch
	...
	float BufferedInChannel_ms; /*
								 * Simulated number of ms buffer in channel
								 * because of exceeded TargetRate_bps
								 */
	...
	float inBandFEC_SNR_comp; /*
							 * Compensation to SNR_DB when using inband FEC
							 * Voiced
							 */
...
class SKP_Silk_encoder_control_FLP {
	...
	float[][] PredCoef = new float[2][Define.MAX_LPC_ORDER]; /*
															 * holds
															 * interpolated and
															 * final
															 * coefficients
	...
	/* Testing */
	// TODO SKP_array_of_int16_4_byte_aligned( AR2_Q13, NB_SUBFR *
	// SHAPE_LPC_ORDER_MAX );
