...
public class NLSF2AStable {
	...
	static void SKP_Silk_NLSF2A_stable(short pAR_Q12[], /*
		...
		for (i = 0; i < Define.MAX_LPC_STABILIZE_ITERATIONS; i++) {
			if (LPCInvPredGain.SKP_Silk_LPC_inverse_pred_gain(invGain_Q30_ptr,
					pAR_Q12, LPC_order) == 1) {
				Bwexpander.SKP_Silk_bwexpander(pAR_Q12, LPC_order,
						65536 - Macros.SKP_SMULBB(66, i)); /* 66_Q16 = 0.001 */
			} else {
				break;
			}
		}
