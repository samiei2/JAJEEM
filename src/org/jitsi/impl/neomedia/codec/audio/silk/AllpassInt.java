...
public class AllpassInt {
	 ...
	 *            Number of samples
	 */
	static void SKP_Silk_allpass_int(final int[] in, /* I: Q25 input signal [len] */
			int in_offset, int[] S, /* I/O: Q25 state [1] */
			int S_offset, int A, /* I: Q15 coefficient (0 <= A < 32768) */
			int[] out, /* O: Q25 output signal [len] */
			int out_offset, final int len /* I: Number of samples */
	) {
		int Y2, X2, S0;
		int k;
