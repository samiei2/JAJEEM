...
class SKP_SILK_SDK_EncControlStruct {
	...
	/**
	 * (Input) Number of samples per packet; must be equivalent of 20, 40, 60,
	 * 80 or 100 ms.
	 */
	int packetSize;
	...
	/**
	 * (Input) Complexity mode; 0 is lowest; 1 is medium and 2 is highest
	 * complexity.
	 */
	int complexity;
...
class SKP_SILK_SDK_DecControlStruct {
	...
	/**
	 * (Output) Flag to indicate that the decoder has remaining payloads
	 * internally.
	 */
