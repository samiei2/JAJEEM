...
public class PerceptualParametersFLP {
	...
	/*
	 * threshold for sparseness measure above which to use lower quantization
	 * offset during unvoiced
	 */
	...
	/*
	 * factor to reduce all bandwdith expansion coefficients for super wideband,
	...
	/*
	 * parameter for shaping noise extra towards higher frequencies during
	 * voiced speech
	 */
	...
	/*
	 * less reduction of noise at the very low frequencies for signals with low
	...
	/*
	 * fraction of first autocorrelation value added to residual energy value;
	 * limits prediction gain
	 */
	...
	/*
	 * subframe smoothing coefficient for determining active speech gain level
