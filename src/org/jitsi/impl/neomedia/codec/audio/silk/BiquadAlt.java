...
public class BiquadAlt {
	 ...
	 */
	static void SKP_Silk_biquad_alt(short[] in, /* I: Input signal */
			int in_offset, int[] B_Q28, /* I: MA coefficients [3] */
			int[] A_Q28, /* I: AR coefficients [2] */
			int[] S, /* I/O: State vector [2] */
			short[] out, /* O: Output signal */
			int out_offset, final int len /* I: Signal length (must be even) */
	) {
