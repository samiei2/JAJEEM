...
public class ResamplerPrivateUp4 {
	/**
	 * Upsample by a factor 4. Note: very low quality, only use with output
	 ...
	 */
	static void SKP_Silk_resampler_private_up4(int[] S, /*
														 * I/O: State vector [ 2
														 * ]
														 */
		...
		for (k = 0; k < len; k++) {
			...
			out16 = (short) SigProcFIX.SKP_SAT16(SigProcFIX.SKP_RSHIFT_ROUND(
					out32, 10));
