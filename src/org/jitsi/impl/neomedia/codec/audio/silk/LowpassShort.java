...
public class LowpassShort {
	 ...
	 *            Signal length
	 */
	static void SKP_Silk_lowpass_short(final short[] in, /*
														 * I: Q15 48 kHz signal;
														 * [len]
														 */
			int in_offset, int[] S, /* I/O: Q25 state; length = 1 */
			int S_offset, int[] out, /* O: Q25 48 kHz signal; [len] */
			int out_offset, final int len /* O: Signal length */
	) {
		int k;
