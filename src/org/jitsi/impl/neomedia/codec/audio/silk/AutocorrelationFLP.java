...
public class AutocorrelationFLP {
	...
	static void SKP_Silk_autocorrelation_FLP(float[] results, /*
															 ...
															 * correlationCount)
															 */
			int results_offset, float[] inputData, /* I input data to correlate */
			int inputData_offset, int inputDataSize, /* I length of input */
		...
		for (i = 0; i < correlationCount; i++) {
			results[results_offset + i] = (float) InnerProductFLP
					.SKP_Silk_inner_product_FLP(inputData, inputData_offset,
