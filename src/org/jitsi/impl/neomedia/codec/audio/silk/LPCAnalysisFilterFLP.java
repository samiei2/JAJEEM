...
/**
 * LPC analysis filter NB! State is kept internally and the filter always starts
 * with zero state first Order output samples are not set
 * 
 * @author Jing Dai
 * @author Dignxin Xu
 */
public class LPCAnalysisFilterFLP {
	...
	static void SKP_Silk_LPC_analysis_filter_FLP(float r_LPC[], /*
			...
			int s_offset, final int length, /* I Length of input signal */
		...
		switch (Order) {
		case 8:
			SKP_Silk_LPC_analysis_filter8_FLP(r_LPC, PredCoef, s, s_offset,
					length);
			break;

		case 10:
			SKP_Silk_LPC_analysis_filter10_FLP(r_LPC, PredCoef, s, s_offset,
					length);
			break;

		case 12:
			SKP_Silk_LPC_analysis_filter12_FLP(r_LPC, PredCoef, s, s_offset,
					length);
			break;

		case 16:
			SKP_Silk_LPC_analysis_filter16_FLP(r_LPC, PredCoef, s, s_offset,
					length);
			break;
