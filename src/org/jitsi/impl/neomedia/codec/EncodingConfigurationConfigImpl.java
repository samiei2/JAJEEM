...
public class EncodingConfigurationConfigImpl extends EncodingConfigurationImpl {
	 ...
	 * properties
	 */
	private ConfigurationService configurationService = LibJitsi
	...
	private void loadConfig() {
		...
		for (String pName : configurationService.getPropertyNamesByPrefix(
				propPrefix, false)) {
	...
	public void setPriority(MediaFormat encoding, int priority) {
		...
		configurationService.setProperty(propPrefix + "."
				+ getEncodingPreferenceKey(encoding), priority);
	}
}
