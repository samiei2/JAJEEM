...
public class ChangeEventDispatcher {
	...
	public synchronized void removePropertyChangeListener(String propertyName,
			PropertyChangeListener listener) {
		if (propertyChangeChildren != null) {
			ChangeEventDispatcher child = propertyChangeChildren
					.get(propertyName);
	...
	public synchronized void removeVetoableChangeListener(String propertyName,
			ConfigVetoableChangeListener listener) {
		if (vetoableChangeChildren != null) {
			ChangeEventDispatcher child = vetoableChangeChildren
					.get(propertyName);
	...
	// throws PropertyVetoException
	{
		...
		synchronized (this) {
			if (vetoableChangeListeners != null) {
				targets = vetoableChangeListeners
	...
	public synchronized boolean hasVetoableChangeListeners(String propertyName) {
		if (vetoableChangeListeners != null
				&& !vetoableChangeListeners.isEmpty()) {
			// there is a generic listener
			return true;
		}
		if (vetoableChangeChildren != null) {
