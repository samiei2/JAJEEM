...
/**
 * A simple in-memory {@link ConfigurationStore} implementation that only uses a
 * hashtable.
 * 
 * @param <T>
...
public abstract class HashtableConfigurationStore<T extends Hashtable>
	...
	/**
	 * Creates an instance of this class using <tt>properties</tt> as the set of
	 * properties where it will be storing an retrieving properties.
	 * 
	 * @param properties
	 *            the map that this store will use for storing and retrieving
	 *            properties.
	 */
