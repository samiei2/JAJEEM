...
public abstract class DatabaseConfigurationStore extends
		HashtableConfigurationStore<Hashtable> {
	/**
	 ...
	 * 
	 * @param properties
	 *            the <tt>Hashtable</tt> which is to become the runtime storage
	 *            of the new instance
	 */
	 ...
	 * 
	 * @throws IOException
	 *             if there is an input error while reading from the underlying
	 *             database (storage)
	 */
	 ...
	 *             managed by this <tt>ConfigurationStore</tt> instance into its
