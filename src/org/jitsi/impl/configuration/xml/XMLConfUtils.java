...
public class XMLConfUtils extends XMLUtils {
	 ...
	 * @param chain
	 *            a String array containing the names of all the child's parent
	 *            nodes.
	 ...
	 * @param path
	 *            an array of <tt>String</tt> elements which represents the path
	 *            to be created. Each element of <tt>path</tt> up to and
	 *            including the index <code>pathLength - 1</code> must be valid
	 *            XML (element) names
	 * @param pathLength
