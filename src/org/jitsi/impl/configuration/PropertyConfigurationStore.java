 ...
 * associations in a <tt>Properties</tt> instance and supports its serialization
 * format for the configuration file of <tt>ConfigurationServiceImpl</tt>.
 * Because of the <tt>Properties</tt> backend which can associate names only
 * <tt>String</tt> values, instances of <tt>PropertyConfigurationStore</tt>
 * convert property values to <tt>String</tt> using <tt>Object#toString()</tt>.
 * 
 * @author Lyubomir Marinov
 */
public class PropertyConfigurationStore extends
		HashtableConfigurationStore<Properties> {
	/**
	 ...
	 * @throws IOException
	 *             if there is an output error while storing the properties
	 *             managed by this <tt>ConfigurationStore</tt> into the
