	...
	private static void checkDestinationDirectory(String pattern) {
		try {
			...
			if (ix != -1) {
				...
				dirName = dirName.replaceAll("%h",
						System.getProperty("user.home"));
				dirName = dirName.replaceAll("%t",
