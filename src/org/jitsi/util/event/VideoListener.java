...
public interface VideoListener extends EventListener {
	 ...
	 *            <tt>Component</tt> representing video and the provider it was
	 *            added into
	 */
	 ...
	 * 
	 * @param event
	 *            a <tt>VideoEvent</tt> describing the visual <tt>Component</tt>
	 *            related to the update and the details of the specific update
	 */
