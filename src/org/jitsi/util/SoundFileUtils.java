...
public class SoundFileUtils {
	...
	public static boolean isSoundFile(File f) {
		...
		if (ext != null) {
			return ext.equals(wma) || ext.equals(wav) || ext.equals(ram)
					|| ext.equals(ogg) || ext.equals(mp3) || ext.equals(mp2)
					|| ext.equals(mod) || ext.equals(mid) || ext.equals(gsm)
					|| ext.equals(au);
		}
		return false;
	}
	...
	public static boolean isSoundFile(File f, String[] soundFormats) {
		...
		// parameter.
			...
			if (ext != null) {
				return (Arrays.binarySearch(soundFormats, ext,
