 ...
 * 
 * <p>
 * Utility class used by {@link XMLUtils} and
...
public class DOMElementWriter {
	...
	public static String decodeName(String name) {
		...
		for (int i = 0; i < length;) {
			...
			if ((end < length) && (name.charAt(start + 1) == 'x')
					&& (name.charAt(end) == '_')
	 ...
	 * 
	 * @param value
	 *            the <tt>String</tt> to be encoded so that it is a valid XML
	 *            name
	 ...
	 *             if an error happens while writing to the stream.
	 */
	public void write(Node element, Writer out, int indent, String indentWith)
			throws IOException {
