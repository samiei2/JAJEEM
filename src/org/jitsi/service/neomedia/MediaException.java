...
public class MediaException extends Exception {
	 ...
	 *            the detailed message to initialize the new instance with
	 * @param errorCode
	 *            the error code which is to give more information about the
	 *            specifics of the new instance
	 */
	 ...
	 *            the detailed message to initialize the new instance with
	 * @param cause
	 *            the <tt>Throwable</tt> which is to be carried by the new
	 *            instance and which is to be reported as the cause for throwing
	 *            the new instance. If <tt>cause</tt> is <tt>null</tt>, the
	 *            cause for throwing the new instance is considered to be
	 *            unknown.
	 */
