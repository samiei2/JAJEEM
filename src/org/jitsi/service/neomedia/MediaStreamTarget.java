...
public class MediaStreamTarget {
	 ...
	 */
	public MediaStreamTarget(InetAddress rtpAddr, int rtpPort,
			InetAddress rtcpAddr, int rtcpPort) {
		this(new InetSocketAddress(rtpAddr, rtpPort), new InetSocketAddress(
				rtcpAddr, rtcpPort));
	}
	...
	public boolean equals(Object obj) {
		...
		return addressesAreEqual(getControlAddress(),
				mediaStreamTarget.getControlAddress())
				&& addressesAreEqual(getDataAddress(),
	...
	public String toString() {
		return getClass().getSimpleName() + " with dataAddress "
				+ getDataAddress() + " and controlAddress "
				+ getControlAddress();
	}
}
