 ...
 * mixing flows from numerous contributors. It is up to upper layers such as SIP
 * to define means of determining the exact members that the CSRC IDs and hence
 * audio levels participants belong to.
 * 
 * @author Emil Ivov
 */
public interface CsrcAudioLevelListener {
	 ...
	 * 
	 * @param audioLevels
	 *            a <tt>long</tt> array in which the elements at the even
	 *            indices specify the CSRC IDs and the elements at the odd
	 *            indices specify the respective audio levels
	 */
