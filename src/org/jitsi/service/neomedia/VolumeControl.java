...
public interface VolumeControl {
	 ...
	 * of audio input.
	 */
	public final static String CAPTURE_VOLUME_LEVEL_PROPERTY_NAME = "net.java.sip.communicator.service.media.CAPTURE_VOLUME_LEVEL";

	/**
	 * The name of the configuration property which specifies the volume level
	 * of audio output.
	 */
	public final static String PLAYBACK_VOLUME_LEVEL_PROPERTY_NAME = "net.java.sip.communicator.service.media.PLAYBACK_VOLUME_LEVEL";
	 ...
	 * 
	 * @param listener
	 *            the <tt>VolumeChangeListener</tt> to be informed about changes
	 *            in the volume level of this instance
	 */
	 ...
	 * 
	 * @param listener
	 *            the <tt>VolumeChangeListener</tt> to no longer be notified
	 *            about changes in the volume level of this instance
	 */
