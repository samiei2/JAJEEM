...
public class JNIEncoder extends AbstractCodec2 {
	...
	private static native void g722_encoder_process(long encoder, byte[] input,
	 ...
	 */
	public JNIEncoder() {
		super("G.722 JNI Encoder", AudioFormat.class,
	...
	protected int doProcess(Buffer inputBuffer, Buffer outputBuffer) {
		...
		g722_encoder_process(encoder, input, inputOffset, output, outputOffset,
				outputLength);
	...
	public Format getOutputFormat() {
		...
		if ((outputFormat != null)
			...
			setOutputFormat(new AudioFormat(outputAudioFormat.getEncoding(),
