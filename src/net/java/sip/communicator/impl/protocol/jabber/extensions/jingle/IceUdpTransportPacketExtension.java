...
public class IceUdpTransportPacketExtension extends AbstractPacketExtension {
	...
	public List<? extends PacketExtension> getChildExtensions() {
		synchronized (candidateList) {
			if (candidateList.size() > 0) {
				...
				List<RemoteCandidatePacketExtension> list = new ArrayList<RemoteCandidatePacketExtension>();
	 ...
	 * 
	 * @param candidate
	 *            the new {@link CandidatePacketExtension} to add to this
	 *            transport element.
	 */
	 ...
	 * 
	 * @param candidate
	 *            the <tt>CandidatePacketExtension</tt> to remove from this
	 *            transport element
	 * @return <tt>true</tt> if the list of <tt>CandidatePacketExtension</tt>s
	 *         registered with this transport contained the specified
	 *         <tt>candidate</tt>
	 */
	 ...
	 * 
	 * @param candidate
	 *            the new {@link CandidatePacketExtension} to set as an in-use
	...
	/**
	 * Tries to determine whether <tt>childExtension</tt> is a
	 * {@link CandidatePacketExtension}, a
	 * {@link RemoteCandidatePacketExtension} or something else and then adds it
	 * as such.
	 * 
