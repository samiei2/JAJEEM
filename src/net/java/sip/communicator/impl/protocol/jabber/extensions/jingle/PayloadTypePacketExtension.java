...
public class PayloadTypePacketExtension extends AbstractPacketExtension {
	...
	public int getChannels() {
		/*
		 * XEP-0167: Jingle RTP Sessions says: if omitted, it MUST be assumed to
		 * contain one channel.
		 */
	 ...
	 *         subtype of the MIME type. Setting this field is RECOMMENDED for
	 *         static payload types, REQUIRED for dynamic payload types.
	 */
