...
public class MuteSessionInfoPacketExtension extends SessionInfoPacketExtension {
	 ...
	 * 
	 * @param mute
	 *            <tt>true</tt> if the new instance is to be of the
	 *            {@link SessionInfoType#mute} type and <tt>false</tt> for a
	 *            {@link SessionInfoType#unmute}
	 * @param name
	 *            the name of the session to be muted or <tt>null</tt> if the
	 ...
	 * 
	 * @return <tt>true</tt> if this packet represents a
	 *         {@link SessionInfoType#mute} and <tt>false</tt> otherwise.
	 */
