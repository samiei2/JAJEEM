...
public class JinglePacketFactory {
	 ...
	 * 
	 * @param sessionInitiate
	 *            the {@link JingleIQ} that established the session which the
	 *            response is going to belong to.
	 * 
	...
	public static JingleIQ createRinging(JingleIQ sessionInitiate) {
		return createSessionInfo(sessionInitiate.getTo(),
				sessionInitiate.getFrom(), sessionInitiate.getSID(),
	 ...
	 *            their full jid
	 * @param sid
	 *            the ID of the Jingle session this IQ will belong to.
	 * 
	 ...
	 *            the ID of the Jingle session this IQ will belong to.
	 * @param type
	 *            the exact type (e.g. ringing, hold, mute) of the session info
	 *            IQ.
	 * 
	 * @return a {@link JingleIQ} <tt>session-info</tt> packet carrying a the
	 *         specified payload type.
	 */
	public static JingleIQ createSessionInfo(String from, String to,
			String sid, SessionInfoType type) {
		JingleIQ ringing = createSessionInfo(from, to, sid);
		SessionInfoPacketExtension sessionInfoType = new SessionInfoPacketExtension(
				type);
	 ...
	 * @param reasonText
	 *            a human readable reason for the termination or <tt>null</tt>
	 *            for none.
	 * 
	 * @return the newly constructed {@link JingleIQ} <tt>session-terminate</tt>
	 *         packet. .
	 */
	public static JingleIQ createSessionTerminate(String from, String to,
			String sid, Reason reason, String reasonText) {
		...
		ReasonPacketExtension reasonPacketExt = new ReasonPacketExtension(
	 ...
	 *         packet.
	 */
	public static JingleIQ createSessionAccept(String from, String to,
			String sid, Iterable<ContentPacketExtension> contentList) {
	 ...
	 *         packet.
	 */
	public static JingleIQ createSessionInitiate(String from, String to,
			String sid, List<ContentPacketExtension> contentList) {
	 ...
	 *         packet.
	 */
	public static JingleIQ createContentAdd(String from, String to, String sid,
	 ...
	 *         packet.
	 */
	public static JingleIQ createContentAccept(String from, String to,
			String sid, Iterable<ContentPacketExtension> contentList) {
	 ...
	 *         packet.
	 */
	public static JingleIQ createContentReject(String from, String to,
			String sid, Iterable<ContentPacketExtension> contentList) {
	 ...
	 *         packet.
	 */
	public static JingleIQ createContentModify(String from, String to,
			String sid, ContentPacketExtension content) {
	 ...
	 *         packet.
	 */
	public static JingleIQ createContentRemove(String from, String to,
			String sid, Iterable<ContentPacketExtension> contentList) {
