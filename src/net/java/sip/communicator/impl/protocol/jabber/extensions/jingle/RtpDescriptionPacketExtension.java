...
public class RtpDescriptionPacketExtension extends AbstractPacketExtension {
	 ...
	 */
	private List<RTPHdrExtPacketExtension> extmapList = new ArrayList<RTPHdrExtPacketExtension>();
	 ...
	 * 
	 * @param encryption
	 *            the encryption {@link PacketExtension} we'd like to add to
	 *            this packet.
	 */
	 ...
	 * 
	 * @param bandwidth
	 *            the max/preferred bandwidth indication that we'd like to add
	 *            to this packet.
	 */
	 ...
	 * 
	 * @param extmap
	 *            an optional <tt>extmap</tt> element that allows negotiation
