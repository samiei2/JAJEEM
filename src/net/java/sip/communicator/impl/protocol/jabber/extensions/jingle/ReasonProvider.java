...
/**
 * The <tt>ReasonProvider</tt> parses "reason" elements into
 * {@link ReasonPacketExtension} instances.
 * 
 * @author Emil Ivov
 */
public class ReasonProvider implements PacketExtensionProvider {
	 ...
	 * {@link ReasonPacketExtension} instance. At the beginning of the method
	 ...
	 * 
	 * @param parser
	 *            an XML parser positioned at the opening <tt>reason</tt>
	 *            element.
	 * 
	...
	public ReasonPacketExtension parseExtension(XmlPullParser parser)
			...
			if (eventType == XmlPullParser.START_TAG) {
				...
				if (reason == null) {
					...
					reason = Reason.parseString(elementName);
						...
						.equals(ReasonPacketExtension.TEXT_ELEMENT_NAME)) {
		...
		ReasonPacketExtension reasonExt = new ReasonPacketExtension(reason,
				text, (PacketExtension) null);
