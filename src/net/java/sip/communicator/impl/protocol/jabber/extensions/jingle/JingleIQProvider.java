...
public class JingleIQProvider implements IQProvider {
	...
	public JingleIQProvider() {
		...
		providerManager.addExtensionProvider(
				...
				new DefaultPacketExtensionProvider<ZrtpHashPacketExtension>(
		...
		providerManager.addExtensionProvider(
				...
				RtpDescriptionPacketExtension.NAMESPACE,
				new DefaultPacketExtensionProvider<CryptoPacketExtension>(
		...
		providerManager.addExtensionProvider(CoinPacketExtension.ELEMENT_NAME,
	...
	public JingleIQ parseIQ(XmlPullParser parser) throws Exception {
		...
		String initiator = parser.getAttributeValue("",
				JingleIQ.INITIATOR_ATTR_NAME);
		String responder = parser.getAttributeValue("",
				JingleIQ.RESPONDER_ATTR_NAME);
		...
		DefaultPacketExtensionProvider<ContentPacketExtension> contentProvider = new DefaultPacketExtensionProvider<ContentPacketExtension>(
				ContentPacketExtension.class);
		ReasonProvider reasonProvider = new ReasonProvider();
		DefaultPacketExtensionProvider<TransferPacketExtension> transferProvider = new DefaultPacketExtensionProvider<TransferPacketExtension>(
				TransferPacketExtension.class);
		DefaultPacketExtensionProvider<CoinPacketExtension> coinProvider = new DefaultPacketExtensionProvider<CoinPacketExtension>(
				CoinPacketExtension.class);
			...
			if (eventType == XmlPullParser.START_TAG) {
				...
				if (namespace.equals(SessionInfoPacketExtension.NAMESPACE)) {
					...
					// <hold/>, <unhold/>, <active/>, etc.
						...
						jingleIQ.setSessionInfo(new SessionInfoPacketExtension(
								type));
					}
				}
			}
