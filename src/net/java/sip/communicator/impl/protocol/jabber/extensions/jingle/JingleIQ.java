...
public class JingleIQ extends IQ {
	 ...
	 * 
	 * @param action
	 *            the value of the <tt>action</tt> attribute.
	 */
	 ...
	 * 
	 * @param reason
	 *            this IQ's <tt>reason</tt> extension.
	 */
	 ...
	 * 
	 * @param contentPacket
	 *            the content packet extension we'd like to add to this
	 ...
	 * would for example contain a <tt>content</tt> element of type
	 ...
	 *         contains a child of the specified <tt>contentType</tt> and
	 ...
	 *         specified <tt>contentType</tt> or <tt>null</tt> if no such child
	 *         was found.
	 */
	public ContentPacketExtension getContentForType(
		...
		synchronized (contentList) {
			for (ContentPacketExtension content : contentList) {
				PacketExtension child = content
						.getFirstChildOfType(contentType);
				if (child != null) {
					return content;
				}
			}
	 ...
	 * 
	 * @param si
	 *            a {@link SessionInfoPacketExtension} that we'd like to add
	 *            here.
	 */
