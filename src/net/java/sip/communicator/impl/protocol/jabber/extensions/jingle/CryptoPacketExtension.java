...
public class CryptoPacketExtension extends AbstractPacketExtension {
	...
	/**
	 * The namespace for the "crypto" element. It it set to "not null" only for
	 * Gtalk SDES support (may be set to null once gtalk supports jingle).
	 */
	 ...
	 * 
	 * @param cryptoAttribute
	 *            The cryptoAttribute containing the crypto-suite, key-params,
	 ...
	 * 
	 * @param cryptoSuite
	 *            a <tt>String</tt> that describes the encryption and
	...
	public boolean equalsCryptoSuite(String cryptoSuite) {
		...
		return CryptoPacketExtension.equalsStrings(currentCryptoSuite,
				cryptoSuite);
	}
	 ...
	 * 
	 * @param keyParams
	 *            a <tt>String</tt> that provides one or more sets of keying
	 ...
	 * 
	 * @param sessionParams
	 *            a <tt>String</tt> that provides transport-specific parameters
	...
	public boolean equalsSessionParams(String sessionParams) {
		...
		return CryptoPacketExtension.equalsStrings(currentSessionParams,
				sessionParams);
	}
	 ...
	 * 
	 * @param tag
	 *            a <tt>String</tt> containing a decimal number used as an
	 *            identifier for a particular crypto element.
	 */
	...
	public SrtpCryptoAttribute toSrtpCryptoAttribute() {
		...
		return SrtpCryptoAttribute.create(this.getTag(), this.getCryptoSuite(),
				this.getKeyParams(), this.getSessionParams());
	}
	 ...
	 * 
	 * @param string1
	 *            A String to be compared with the second one.
	 * @param string2
	 *            A String to be compared with the fisrt one.
	 * 
	 ...
	 * 
	 * @param obj
	 *            an object which might be an instance of CryptoPacketExtension.
	 * 
	...
	public boolean equals(Object obj) {
		if (obj instanceof CryptoPacketExtension) {
			...
			return (crypto.equalsCryptoSuite(this.getCryptoSuite())
					...
					&& crypto.equalsSessionParams(this.getSessionParams()) && crypto
						.equalsTag(this.getTag()));
		}
		return false;
	}
}
