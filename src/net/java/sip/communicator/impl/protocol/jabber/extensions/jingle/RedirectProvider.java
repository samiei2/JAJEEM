...
/**
 * The <tt>RedirectProvider</tt> parses "redirect" elements into
 * {@link RedirectPacketExtension} instances.
 * 
...
public class RedirectProvider implements PacketExtensionProvider {
	 ...
	 * {@link RedirectPacketExtension} instance. At the beginning of the method
	 ...
	 * 
	 * @param parser
	 *            an XML parser positioned at the opening <tt>redirect</tt>
	 *            element.
	 * 
