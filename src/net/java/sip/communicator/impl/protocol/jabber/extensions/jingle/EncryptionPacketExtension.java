...
public class EncryptionPacketExtension extends AbstractPacketExtension {
	/**
	 * The namespace of the "encryption" element. It it set to "not null" only
	 * for Gtalk SDES support (may be set to null once gtalk supports jingle).
	 */
	 ...
	 */
	private List<CryptoPacketExtension> cryptoList = new ArrayList<CryptoPacketExtension>();
	 ...
	 * 
	 * @param crypto
	 *            the new <tt>crypto</tt> element to add.
	 */
	 ...
	 * 
	 * @param required
	 *            <tt>true</tt> if encryption is required for this session and
