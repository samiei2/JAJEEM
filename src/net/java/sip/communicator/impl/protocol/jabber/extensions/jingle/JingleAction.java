...
public enum JingleAction {
	 ...
	 * party; if not, it MUST send a <tt>content-reject</tt> action to the other
	 * party.
	 */
	 ...
	 * 
	 * @param actionName
	 *            the name of the <tt>JingleAction</tt> we'd like to create.
	 */
	 ...
	 * 
	 * @param jingleActionStr
	 *            the action <tt>String</tt> that we'd like to parse.
	 * @return a <tt>JingleAction</tt> value corresponding to the specified
	 *         <tt>jingleActionStr</tt>.
	 * 
	 * @throws IllegalArgumentException
	 *             in case <tt>jingleActionStr</tt> is not a valid media
	 *             direction.
	 */
	public static JingleAction parseString(String jingleActionStr)
		...
		throw new IllegalArgumentException(jingleActionStr
				+ " is not a valid jingle action");
	}
}
