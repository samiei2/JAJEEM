...
//    	JOptionPane.showMessageDialog(null, "2!");
    	new TestPlayer(mrl,bool);
//    	JOptionPane.showMessageDialog(null, "Video Player Open!");
...
//        });
    ...
    public TestPlayer(String stream, boolean b) {
    	LoadingDialog diag = new LoadingDialog();
...
//                RuntimeUtil.getLibVlcLibraryName(), "util/vlclib"
//            );
    	NativeLibrary.addSearchPath(
...
//        JOptionPane.showMessageDialog(null, "6!");
        ...
        mainFrame = new JFrame("Media Player");
        mainFrame.setSize(800, 600);
        mainFrame.setMinimumSize(new Dimension(800, 600));
        mainFrame.setIconImage(new ImageIcon(getClass().getResource("/icons/Video-icon.png")).getImage());

        FullScreenStrategy fullScreenStrategy = new DefaultFullScreenStrategy(mainFrame);

        mediaPlayerFactory = new MediaPlayerFactory(vlcArgs.toArray(new String[vlcArgs.size()]));
        mediaPlayerFactory.setUserAgent("media player");
    ...
    private JMenuBar buildMenuBar() {
        ...
        mediaPlayStreamMenuItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				mediaPlayer.enableOverlay(false);
                String mediaUrl = JOptionPane.showInputDialog(mainFrame, "Enter a media URL", "Connect to media", JOptionPane.QUESTION_MESSAGE);
